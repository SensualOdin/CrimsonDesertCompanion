...
{type:"tip",text:"Kilnden Workshop: produce Kuku Iron Pots — Axiom Force storage containers that hold grabbed objects regardless of size or weight."},
...
{type:"tip",text:"Kilnden Workshop: produce Kuku Iron Pots — Axiom Force storage containers for grabbed objects of any size or weight."},
...
tags:["dispatch","freesword","missions","resources","comrades","Ross","Luke","siege","farming","income","silver","armaments","food","timber","stone"],
content:[
...
{type:"tip",text:"Access via Ross (Freesword Management Office) at camp, or open the map while standing in camp → hover camp icon → press Y/Triangle → tab to Mission List with RB/R1."},
{type:"tip",text:"Each mission has a minimum and maximum comrade count. Missions run on in-game time. Missions auto-restart on completion — cancel manually to reassign. Cancelled missions refund their resource cost in full."},
{type:"tip",text:"Luke handles dispatch assignments at camp. Check each recruit's skill profile before sending anyone out."},
{type:"heading",text:"Mission Types"},
{type:"table",headers:["Type","Rewards","Costs"],
rows:[
["Escort","Silver (money)","Food"],
["Harvesting / Farming","Food, trade goods","Money"],
["Mining","Stone","Money, food"],
["Logging","Timber","Money, food"],
["Recapture Stronghold","Fewer enemies in that area","Armaments, food, money"],
["Production","Crafted items (Engineer required)","Armaments, food, money"],
["Crafting","Items, trade goods (specific skill required)","Varies"]
]},
{type:"heading",text:"Skill System"},
{type:"tip",text:"Skills fall into two groups. Efficiency Boosters (Escort, Farmer, Rancher, Fisherman, Smith, Logger, Miner) increase yields when matched to a mission type. Required Skills (Craftsman, Jeweler, Engineer, Cook, Explorer, Painter, Weaver) are mandatory — at least one comrade with that skill must be assigned or the mission won't run."},
{type:"tip",text:"Skill levels: L1 (grey icon, white image) = +10% reward bonus. L2 (gold icon, grey image) = +30%. L3 (gold icon, gold image) = +60%. All 3 levels on one comrade = 100% Skill Bonus."},
{type:"warning",text:"Bonuses do NOT stack from duplicates. Two L1 comrades = still only 10%. You need one comrade with all 3 tiers for the full 100%. Example: Brant has Novice/Skilled/Expert Escort — sending him on any Escort mission gives the full bonus."},
{type:"heading",text:"Comrade Bonus"},
{type:"tip",text:"Every mission has a minimum and maximum headcount. Sending more than the minimum earns a Comrade Bonus: +1 above minimum = 20% boost, +2 above = 40%. Always send extra when you have them available."},
{type:"heading",text:"Resource Chaining"},
{type:"tip",text:"Chain complementary missions for profit loops. Example: Capra Pasture (cabbage harvest — 1k bronze → 1k food) → Oakenshield Manor (mansion guard — 120 food → 1.9k bronze). Net positive on both resources."},
{type:"tip",text:"Early recommended missions: Oakenshield Manor (Hernand) for silver, Capra Pasture for food, Warspike Spearmaker for armaments."},
{type:"tip",text:"Mid-game: Thornbriar Food Storage, Sungrove Manor, Azerian Manor in Demeniss."},
{type:"tip",text:"Late game (Ch10+): Gorthak Ironworks in Delesyia = thousands of armaments per dispatch cycle."},
{type:"heading",text:"Military Dispatches"},
{type:"tip",text:"Recapture Stronghold missions send comrades to attack enemy-held locations. This directly reduces the number of hostile enemies you encounter when visiting those locations — dispatch missions actively shape the open world."},
...
{type:"tip",text:"Rest in the bed at camp to fast-forward dispatch timers. You cannot rest consecutively — there's a cooldown."},
{type:"tip",text:"Supply Chest (behind Carl, max 230 slots) silently accumulates dispatch rewards + missed loot. Check it every time you return to camp."},
{type:"tip",text:"Prioritize recruiting comrades with rare Required Skills (Engineer especially). Arnold (from 'Rumor in St. Halssius') and Falstaff have the Engineer skill. Others like Terry and Otto need camp upgrades to unlock it."},
{type:"warning",text:"Don't neglect food dispatches even late-game. Almost every mission type draws from the food pool. Running dry stalls your entire operation."},
...
tags:["recruit","comrades","Greymane","freesword","Ross","rumor","faction","quest","skills","roster","dispatch","capacity","Arnold","Brant","Ben","Kamu","Brice"],
content:[
...
{type:"tip",text:"After the Black Bears attack, surviving Greymane members are scattered across Pywel. Navigate to Journal → Factions Quests → Greymanes to track recruitment missions."},
{type:"tip",text:"Under the 'Grounds of the Sunrise' tab, missions starting with 'A Rumor...' lead you to old comrades. Marius assigns these as you upgrade camp level."},
{type:"tip",text:"Recruitment methods: story encounters (automatic), side quests (complete objectives), passive arrivals (hear rumors about camp), and active recruitment (dialogue/faction strength)."},
{type:"warning",text:"Random freeswords in the world are NOT recruitable. You are restricted to Greymane comrades found through faction quests."},
{type:"heading",text:"Starting Comrades (Ch3)"},
{type:"table",headers:["Comrade","Role","Notes"],
rows:[
["Carl","Provisions keeper, Supply Chest","Joins at camp founding. Donate items to boost camp growth."],
["Ross","Freesword Management Office","Joins at camp founding. View all comrades + start dispatches."],
["Luke","Dispatch assignments, Construction + Ranching skills","Available from story. Handles dispatch board."],
["Ronald","Dispatch worker, Logging expertise","Available from story. Basic through Expert logging."]
]},
{type:"heading",text:"Key Recruitable NPCs"},
{type:"table",headers:["Comrade","Unlock Quest","Camp Role"],
rows:[
["Ronnie","Camp expansion","Food Shop (Chewy Rice Cakes, Porridge). Expands via Dahlia's contract at Hernand Inn."],
["Brice","A Rumor in Glenbright Farm","Wagon Management Office. Required to start wagon building."],
["Cook + Quartermaster","A Rumor at Glenbright Farm","Ingredient shop + prepared dishes + recipes."],
["Ben","A Rumor in Goldleaf Trading Post","Ranch manager. Triggers 'Field of Abundance' quest."],
["Kamu","A Rumor in Goldleaf Trading Post","Farm manager. Apple picking mission at Glenbright Farm."],
["Tranan","Camp expansion","Camp blacksmith. Buys/sells gear, ammo, refinement items."],
["Arnold","Rumor in St. Halssius","Has Engineer skill. Required for wagon construction."],
["Naira","Side quests","Lookout, 'Empress of the Bow'. Unlocks pets + color dyes."],
["Yann","Side quests","Introduces Royal Trading system."]
]},
{type:"tip",text:"'A Rumor in Goldleaf Trading Post' is especially important — it recruits 6 people at once and unlocks both the ranch and farm."},
{type:"heading",text:"Comrade Skills"},
{type:"tip",text:"Two skill groups: Efficiency Boosters (Escort, Farmer, Rancher, Fisherman, Smith, Logger, Miner) increase mission yields. Required Skills (Craftsman, Jeweler, Engineer, Cook, Explorer, Painter, Weaver) are mandatory for certain mission types."},
{type:"tip",text:"Each skill has 3 levels. L1 = +10%, L2 = +30%, L3 = +60%. All 3 on one comrade = 100% bonus. Example: Brant has Novice/Skilled/Expert Escort."},
{type:"tip",text:"Upgrading Howling Hill via dispatch missions increases skill levels for ALL comrades or unlocks their next available skill."},
{type:"warning",text:"Engineer is the rarest and most critical skill. Arnold and Falstaff have it by default. Others like Terry and Otto need camp upgrades to unlock it."},
{type:"heading",text:"Greymane Commissions"},
{type:"stat",text:"Commission quests come from rescued camp residents: Carl, Ronnie, Ross, Tranan, Brice, Ronald, and Pierce each have requests."},
{type:"tip",text:"27 total Greymane Commissions. Each rewards a Medium Bag (+3 inventory slots) = up to +81 slots total. Massive quality-of-life gain."},
{type:"heading",text:"Tips"},
{type:"tip",text:"Recruit aggressively. More comrades = more dispatch capacity = more resources = faster camp growth."},
{type:"tip",text:"Some recruits unlock entire camp features: Brice = wagon trading, Ben = ranch, Kamu = farm, Ronnie = food shop, Tranan = smithy."},
{type:"tip",text:"Keep missions running at all times, prioritize commissions for inventory rewards, match recruits to missions by skill, and never let food hit zero."},
...
tags:["farm","ranch","crops","livestock","chickens","cows","goats","pigs","seeds","harvest","food","cooking","ingredients","Ben","Kamu","self-sufficient","Goldleaf","Bloomwood"],
content:[
{type:"intro",text:"The Farm and Ranch are your self-sustaining food production facilities. Once operational, they provide a reliable supply of grains, vegetables, meat, milk, and eggs — reducing reliance on open-world gathering and vendor purchases. Resources feed directly into cooking and crafting."},
{type:"heading",text:"Unlocking Both Facilities"},
{type:"tip",text:"Both require progressing the Grounds of the Sunrise faction questline until you unlock 'A Rumor in Goldleaf Trading Post.' This introduces two NPCs: Ben (ranch) and Kamu (farm)."},
{type:"tip",text:"You CANNOT build both simultaneously. If the ranch construction dispatch is running, you must wait for it to finish before starting the farm (and vice versa)."},
{type:"heading",text:"Unlocking the Ranch"},
{type:"tip",text:"After meeting Ben during 'A Rumor in Goldleaf Trading Post,' return to camp and speak with him to start the 'Field of Abundance' quest."},
{type:"tip",text:"Step 1: Dispatch comrades to the Milk Harvest Mission at Bloomwood Ranch."},
{type:"tip",text:"Step 2: Dispatch another mission at Howling Hill to construct the ranch facility."},
{type:"tip",text:"Step 3: Complete 'Ben's Request' — a hands-on tutorial where you catch wild goats, register livestock at the ranch, and slaughter animals for meat."},
{type:"heading",text:"Ranch Livestock"},
{type:"tip",text:"Four animal types: cows (milk, beef), pigs (pork, leather), goats (milk, hides), and chickens (eggs)."},
{type:"tip",text:"Animals require physical interaction — feeding, moving, and slaughtering through direct actions, not menu prompts. This is a hands-on system."},
{type:"tip",text:"You can also sell creatures at camp for silver income."},
{type:"tip",text:"Use ranch meat for Hearty Grilled Meat — one of the best early-to-mid-game healing foods, easy to cook in bulk at the camp kitchen."},
{type:"heading",text:"Unlocking the Farm"},
{type:"tip",text:"Speak with Kamu (also from 'A Rumor in Goldleaf Trading Post'). He requests an apple picking mission at Glenbright Farm."},
{type:"tip",text:"Step 1: Dispatch the Apple Harvest Mission at Glenbright Farm."},
{type:"tip",text:"Step 2: Dispatch a construction mission at Howling Hill to build the farm."},
{type:"heading",text:"Farm Crops"},
{type:"tip",text:"Farm has dedicated crop plots for growing fruit, vegetables, and grains. Harvested crops feed directly into the cooking and alchemy systems."},
{type:"tip",text:"Crops need to be watered by hand — this is NOT a set-and-forget system. You physically pick crops from plots when ready."},
{type:"tip",text:"Sleep at camp to advance in-game time, speeding up crop growth timers."},
{type:"heading",text:"Farm + Ranch Synergy"},
{type:"tip",text:"The real value comes from using both together. Meat plus farm-grown ingredients opens up better recipes that restore Health, Stamina, and Spirit simultaneously."},
{type:"tip",text:"Together, the farm and ranch create a reliable supply chain at your home base, reducing the grind of open-world gathering."},
{type:"tip",text:"Surplus food can be donated to Carl for camp resources, or cooked into sellable dishes for silver."},
{type:"heading",text:"Cooking Connection"},
{type:"tip",text:"Ronnie's Food Shop at camp sells Chewy Rice Cakes and Meat and Vegetable Porridge by default. Expand his stock via the Hernandian Cooking Supply Contract from Dahlia at the Hernand Inn — adds Pickled Vegetables, Braised Fish, and Pan-Fried Rice Cakes."},
{type:"tip",text:"Cook + Quartermaster (unlocked via 'A Rumor at Glenbright Farm') sell ingredients and prepared meals with combat buffs."},
{type:"tip",text:"With Gourmet gear equipped, even basic Grilled Meat heals significantly more."},
{type:"heading",text:"Tips"},
{type:"tip",text:"Rest in camp bed to fast-forward crop growth and livestock production. Cannot rest consecutively — there's a cooldown."},
{type:"tip",text:"Farm and ranch production continues while you adventure. Return periodically to harvest and collect."},
{type:"tip",text:"Pair farm/ranch with food dispatch missions for maximum output. You'll need 4,000 food just for the Level 4 camp expansion."},
...
tags:["Pailune","reconstruction","rebuild","council","institute","late game","Ch7","base building","endgame","Proud Returnee","relocation","camp move"],
content:[
{type:"intro",text:"After Chapter 7, you unlock 'Reconstructing Pailune' — a multi-stage faction questline to rebuild the Greymanes' ancestral homeland in the northern region. This is the endgame evolution of base building, culminating in permanently relocating your camp from Howling Hill to Pailune."},
{type:"heading",text:"Unlocking Reconstruction"},
{type:"tip",text:"Complete the Ch7 main quest 'Time to Face Justice.' The 'Reconstructing Pailune' questline then becomes available under Factions Quests → Greymanes."},
{type:"tip",text:"Pailune was once home to the Greymanes but has been overrun by the Black Bears. During Ch7, your party fights through Pailune to reclaim the region. Reconstruction begins afterward."},
{type:"heading",text:"What's Involved"},
{type:"tip",text:"The reconstruction questline involves gathering specific materials, completing construction dispatch tasks, and interacting with companions at Pailune. Use the dispatch system to gather materials efficiently."},
{type:"tip",text:"Introduces large-scale projects including the Pailune Council and Pailune Institute, both of which offer new dispatch missions and research opportunities."},
{type:"heading",text:"Pailune Institute"},
{type:"tip",text:"Part of the Research System — one of the most impactful endgame upgrade paths. You fund projects with silver, and they complete over several in-game hours."},
{type:"tip",text:"You can accelerate research timers by sleeping or waiting at campfires. Research occasionally stalls, requiring you to complete specific tasks for the scientists before work resumes."},
{type:"tip",text:"The Institute specializes in reconstruction-related research, complementing other research institutes across Pywel (like Scholastone and Gorthak Ironworks)."},
{type:"heading",text:"Camp Relocation"},
{type:"tip",text:"Completing the entire 'Reconstructing Pailune' questline allows you to permanently relocate the Greymane Camp from Howling Hill to Pailune."},
{type:"stat",text:"Unlocks the 'Proud Returnee' trophy (Silver). This is separate from story completion trophies — it requires dedicated post-Ch7 work."},
{type:"tip",text:"After relocation, all camp facilities, NPCs, and dispatch systems transfer to the new Pailune location."},
{type:"heading",text:"Post-Game Persistence"},
{type:"tip",text:"All regions remain fully accessible after the story ends: Hernand, Pailune, Demeniss, Delesyia, Tashkalp, and the Crimson Desert. NPCs, vendors, and services continue operating."},
{type:"tip",text:"You can continue expanding camp, running dispatches, and completing faction quests indefinitely in the post-game."},
{type:"heading",text:"Tips"},
{type:"tip",text:"Start stockpiling resources during Ch5-6 if you want to hit the ground running on reconstruction after Ch7."},
{type:"tip",text:"Don't neglect Greymane Camp dispatches while focusing on Pailune. Camp resources fund reconstruction projects — they work in tandem."},
{type:"tip",text:"Late-game dispatch loop: Run Gorthak Ironworks for armaments + Pailune construction simultaneously. Gorthak feeds resources; Pailune burns them productively."},
{type:"warning",text:"Reconstruction requires heavy resource investment. The 4th camp expansion alone costs 1,500 armaments + 2,500 stone + 2,500 timber + 4,000 food + 100,000 silver. Pailune projects demand even more."},
