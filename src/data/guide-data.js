...
"dispatch-missions":{category:"Base Building",title:"Dispatch Mission Strategies",
tags:["dispatch","freesword","missions","resources","comrades","Ross","siege","farming","income","silver","armaments","food","timber","stone"],
content:[
{type:"intro",text:"The Dispatch system is your passive resource engine. Send Greymane comrades on timed missions across Pywel to gather food, timber, stone, armaments, and silver while you adventure. Mastering dispatch routing is the difference between scraping by and swimming in resources."},
{type:"heading",text:"How Dispatch Works"},
{type:"tip",text:"Access via Ross (Dispatch Coordinator) at camp, or Map → Factions tab → highlight any location → Inspect → Missions tab."},
{type:"tip",text:"Each mission requires 1-3 comrades and runs for a set number of in-game hours (typically 12-24h). Missions auto-restart on completion."},
{type:"tip",text:"You can run as many simultaneous missions as you have comrades. More recruits = more parallel dispatches = exponential resource growth."},
{type:"tip",text:"Cancel a running mission anytime to reassign comrades. No penalty, but you lose progress on that run."},
{type:"heading",text:"Mission Types"},
{type:"table",headers:["Icon","Type","Yields","Best Locations"],
rows:[
["Wheat","Harvest","Food, crops, seeds","Capra Pasture, Glenbright Farm, Goldleaf"],
["Axe","Logging","Timber, planks","Thornwood, Northern Pailune forests"],
["Pickaxe","Mining","Stone, ore, gems","Ironflame Mines, Bluemont Quarry"],
["Shield","Bodyguard","Silver, reputation","Trade route escorts, Demeniss caravans"],
["Sword","Siege","Reduced fort resistance","Enemy strongholds, bandit camps"],
["Gear","Engineering","Wagon parts, mechanisms","Wainwright missions, Gorthak"]
]},
{type:"heading",text:"Skill Matching"},
{type:"tip",text:"Every comrade has a primary skill (Farmer, Logger, Miner, Fighter, Engineer). Matching skill to mission type gives 30-50% better yields and faster completion."},
{type:"tip",text:"Check comrade profiles via Ross → Manage Comrades. Skill icons appear next to names. Plan your roster before dispatching."},
{type:"tip",text:"Some comrades have secondary skills. A Fighter with secondary Miner works well on mining missions when no pure Miners are free."},
{type:"warning",text:"Mismatched comrades still complete missions — just slower and with reduced output. Never leave comrades idle."},
{type:"heading",text:"Resource Chaining"},
{type:"tip",text:"Chain complementary missions for profit loops. Example: Capra Pasture (1k bronze → 1k food) → Oakenshield Manor (120 food → 1.9k bronze). Net positive on both resources."},
{type:"tip",text:"Early game focus: Food + Timber. These gate camp expansions Level 2 and 3. Run 60-70% of dispatches on these."},
{type:"tip",text:"Mid game pivot: Armaments become the bottleneck for Level 4 expansion. Shift dispatches to mining + bodyguard missions in Demeniss region."},
{type:"tip",text:"Late game: Gorthak Ironworks (Ch10+) = thousands of armaments per dispatch cycle. This single location solves the armaments problem."},
{type:"heading",text:"Siege Dispatches"},
{type:"tip",text:"Siege missions weaken enemy strongholds on the world map. Send comrades to besiege a fort → when you visit, enemies have reduced HP and fewer reinforcements."},
{type:"tip",text:"Stack multiple siege runs on the same target for maximum softening. 3+ runs = fort is nearly empty when you arrive."},
{type:"tip",text:"Siege is the only dispatch type that directly affects open-world gameplay difficulty. Use it before tackling tough faction zones."},
{type:"heading",text:"Optimization Tips"},
{type:"tip",text:"Keep ALL dispatch slots running at ALL times. Even inefficient missions beat idle comrades."},
{type:"tip",text:"Use bed rest at camp to skip dispatch timers. Sleep has ~12h in-game cooldown, so you can't chain it, but one rest per play session saves hours."},
{type:"tip",text:"Supply Chest (behind Carl) silently accumulates dispatch rewards. Check it every time you return to camp — rewards pile up fast."},
{type:"tip",text:"Prioritize recruiting comrades with rare skills (Engineer, Miner) early. Farmers are common; Engineers are not."},
{type:"warning",text:"Don't neglect food dispatches even late-game. Food drains fastest due to cooking, camp upkeep, and expansion costs. A food shortage stalls everything."},
{type:"links",pages:["camp","greymane-camp","recruit-comrades","trading-wagons"]}
]},
"recruit-comrades":{category:"Base Building",title:"Recruiting Comrades",
tags:["recruit","comrades","Greymane","freesword","Ross","rumor","faction","quest","skills","roster","dispatch","capacity"],
content:[
{type:"intro",text:"Comrades are the backbone of your camp. Every Greymane you recruit adds a dispatch slot, unlocks new camp features, and contributes to faction reputation. Finding them all is a game-long quest that dramatically improves your resource economy."},
{type:"heading",text:"How Recruitment Works"},
{type:"tip",text:"Most comrades are found through 'Rumor' quests. These appear at taverns, notice boards, and through NPC conversations across all regions."},
{type:"tip",text:"Some comrades join automatically through main story progression (Luke, Ronald in Ch3). Others require completing their personal quest chains."},
{type:"tip",text:"Recruited comrades appear at camp and become available for dispatch. Some also run camp facilities (Lonnie = Cook, Tranan = Smithy)."},
{type:"heading",text:"Early Recruits (Ch3-4)"},
{type:"table",headers:["Comrade","Location","How to Recruit","Skill"],
rows:[
["Luke","Main quest (Ch3)","Automatic — story progression","Fighter"],
["Ronald","Main quest (Ch3)","Automatic — story progression","Logger"],
["Carl","Camp setup","Automatic — joins at camp founding","Provisions"],
["Ross","Camp setup","Automatic — joins at camp founding","Coordinator"],
["Lonnie","Glenbright Farm","Complete 'A Rumor at Glenbright Farm'","Cook (Farmer)"],
["Tranan","Hernand smithy","Complete Tranan's trust chain (visit 3x, buy items)","Blacksmith (Engineer)"],
["Ben","Goldleaf area","Start 'A Rumor in Goldleaf' → Milk Harvest dispatch","Rancher (Farmer)"]
]},
{type:"heading",text:"Mid-Game Recruits (Ch5-7)"},
{type:"tip",text:"Hernand tavern notice board refreshes each chapter. Check after every story milestone for new Rumor postings."},
{type:"tip",text:"Pailune region: 3-4 recruitable comrades in frozen highlands. Look for Greymane insignia markers on map after reaching Pailune."},
{type:"tip",text:"Demeniss: 2-3 military-skilled comrades. High Fighter and Engineer stats. Found through Contribution Shop reputation quests."},
{type:"tip",text:"Some recruits require winning duels or bar fights. Bring upgraded gear — these aren't pushover encounters."},
{type:"heading",text:"Late-Game Recruits (Ch8+)"},
{type:"tip",text:"Delesyia region: Engineer-class comrades essential for Wainwright and ATAG-related dispatch missions."},
{type:"tip",text:"Gorthak Ironworks: 2 Miner-class comrades. Critical for armament dispatches in late game."},
{type:"tip",text:"Post-Ch7 Pailune reconstruction unlocks additional recruits through council quests."},
{type:"heading",text:"Comrade Skills & Roles"},
{type:"table",headers:["Skill Class","Dispatch Bonus","Rarity","Notes"],
rows:[
["Farmer","Harvest missions +40%","Common","Most recruits. Essential for food supply."],
["Logger","Logging missions +35%","Common","Timber is needed for every expansion."],
["Fighter","Bodyguard/Siege +30%","Common","Silver income and fort softening."],
["Miner","Mining missions +50%","Rare","Huge bonus. Prioritize recruiting miners."],
["Engineer","Engineering +45%","Very Rare","Required for wagon building and advanced crafts."]
]},
{type:"heading",text:"Roster Management"},
{type:"tip",text:"Access full roster via Ross → Manage Comrades. View skills, current assignment, and idle status."},
{type:"tip",text:"Reassign comrades freely. Match them to the resource you need most right now, but prioritize skill matching for efficiency."},
{type:"tip",text:"Some comrades have unique dialogue and side stories. Talk to them at camp between missions for lore and occasional bonus rewards."},
{type:"warning",text:"You cannot dismiss recruited comrades. Every recruit is permanent. This is fine — more is always better for dispatch capacity."},
{type:"heading",text:"Tips"},
{type:"tip",text:"Recruit aggressively in early chapters. Each comrade you miss delays your resource snowball."},
{type:"tip",text:"27 total Greymane Commissions reward Medium Bags (+3 inventory slots each). Recruitment questlines count toward these."},
{type:"tip",text:"Camp growth boosts Hernandian Contribution reputation. High reputation unlocks Contribution Shop discounts."},
{type:"tip",text:"Certain recruits unlock camp features: Lonnie = free daily food, Tranan = on-site smithy, Ben = ranch, Yann = Royal Trading."},
{type:"links",pages:["camp","greymane-camp","dispatch-missions","faction-rep"]}
]},
"farm-ranch":{category:"Base Building",title:"Farm & Ranch Guide",
tags:["farm","ranch","crops","livestock","chickens","cows","goats","seeds","harvest","food","cooking","ingredients","Ben","Lonnie","self-sufficient"],
content:[
{type:"intro",text:"The Farm and Ranch are your self-sustaining food factories. Once fully operational, they eliminate the need to buy or forage ingredients — producing grains, vegetables, meat, milk, and eggs on a cycle. Essential for endgame cooking and alchemy."},
{type:"heading",text:"Unlocking the Farm"},
{type:"tip",text:"Farm unlocks with Camp Level 3-4 expansion. Requires completing facility construction dispatch (timber + stone + food investment)."},
{type:"tip",text:"Initial farm is small: 4 planting slots. Expands to 8 slots with further camp upgrades."},
{type:"tip",text:"Seeds are planted manually at farm plots. Interact with empty plot → select seed type → confirm. Growth takes 6-12 in-game hours depending on crop."},
{type:"heading",text:"Crops & Growth"},
{type:"table",headers:["Crop","Seed Source","Growth Time","Yields","Used In"],
rows:[
["Wheat","General merchant, loot","6 hours","Flour, Wheat Bundle","Bread, Porridge, most recipes"],
["Barley","Hernand farms, dispatch","8 hours","Barley, Malt","Ale brewing, some soups"],
["Root Vegetables","Foraging, merchants","8 hours","Turnips, Carrots","Stews, side dishes"],
["Herbs","Wild gathering, Pailune","10 hours","Healing Herbs, Spice","Alchemy, seasoning"],
["Crimson Ginseng","High altitude only","12 hours","Crimson Ginseng","Palmar Pills, rare alchemy"]
]},
{type:"tip",text:"Harvest when the crop icon turns golden. Unharvested crops don't spoil — they just occupy the plot until picked."},
{type:"tip",text:"Replant immediately after harvest. Leaving plots empty is wasted time. Set a rotation and stick to it."},
{type:"warning",text:"Crimson Ginseng seeds are extremely rare. Only plant them when you have spares — losing a plot to experimentation hurts."},
{type:"heading",text:"Unlocking the Ranch"},
{type:"tip",text:"Ranch requires Ben as a comrade. Unlock Ben via: 'A Rumor in Goldleaf' → Milk Harvest dispatch → construct ranch → 'Ben's Request' quest."},
{type:"tip",text:"Ranch starts with chicken coops. Cows and goats unlock through additional construction dispatches."},
{type:"heading",text:"Livestock Management"},
{type:"table",headers:["Animal","Produces","Collection Rate","Feed Required","Notes"],
rows:[
["Chickens","Eggs, Feathers","Every 4 hours","Seeds (from farm)","Lowest maintenance. Start here."],
["Cows","Milk, Beef (on slaughter)","Every 8 hours","Hay, Grain","Milk for cooking. Beef is emergency food."],
["Goats","Goat Milk, Pelts","Every 6 hours","Hay, Vegetables","Goat Milk for specific alchemy recipes."]
]},
{type:"tip",text:"Feed animals regularly. Unfed livestock still produce, but at roughly half rate. Keep a seed/grain surplus dedicated to animal feed."},
{type:"tip",text:"Collect products from the collection bin near each enclosure. Products accumulate like the Supply Chest — check regularly."},
{type:"heading",text:"Self-Sufficiency Loop"},
{type:"tip",text:"The goal: Farm produces seeds → feed chickens. Farm produces grain → feed cows/goats. Ranch produces eggs/milk/meat → cook at Lonnie's station or Personal House."},
{type:"tip",text:"A fully operational farm + ranch provides 80-90% of cooking ingredients passively. You only need to buy rare spices and specialty items."},
{type:"tip",text:"Surplus food can be donated to Carl for camp resources, or cooked into sellable dishes for silver income."},
{type:"heading",text:"Cooking Synergy"},
{type:"tip",text:"Lonnie (camp cook) provides free Chewy Rice Cakes and Porridge daily. These use farm ingredients when your supply is connected."},
{type:"tip",text:"Personal House kitchen allows direct cooking. With Gourmet gear equipped, even basic Grilled Meat heals significantly more."},
{type:"tip",text:"Best farm-to-plate recipes: Hearty Stew (root veg + meat + herbs), Fortified Porridge (wheat + milk + eggs), Palmar Pills (Crimson Ginseng + herbs)."},
{type:"warning",text:"Don't sell raw ingredients to vendors. Their value triples when cooked into dishes. Always cook first, sell second."},
{type:"heading",text:"Tips"},
{type:"tip",text:"Use bed rest to speed up crop growth and livestock production cycles. One rest = skip ~12 in-game hours."},
{type:"tip",text:"Farm and ranch production continues while you're out adventuring. Return to camp periodically to harvest and collect."},
{type:"tip",text:"Pair farm/ranch with dispatch food missions for maximum food income. You'll need thousands of food for Level 4 expansion."},
{type:"links",pages:["camp","greymane-camp","cooking-recipes","dispatch-missions"]}
]},
"pailune-rebuild":{category:"Base Building",title:"Pailune Reconstruction",
tags:["Pailune","reconstruction","rebuild","council","institute","late game","Ch7","base building","endgame","projects","reputation"],
content:[
{type:"intro",text:"After Chapter 7 (Homecoming), you unlock the Pailune Reconstruction system — a massive late-game base building project that transforms the war-torn Pailune region. This is the endgame evolution of camp management, with large-scale projects, council politics, and long-term resource investment."},
{type:"heading",text:"Unlocking Reconstruction"},
{type:"tip",text:"Complete Ch7: Homecoming quest. Return to Pailune. Cutscene triggers council formation. Pailune Council + Pailune Institute become available."},
{type:"tip",text:"Reconstruction is separate from Greymane Camp. You manage both simultaneously — camp for daily resources, Pailune for long-term projects."},
{type:"tip",text:"Access via Map → Factions tab → Pailune Council marker. Or visit the council building in Pailune town center."},
{type:"heading",text:"The Council System"},
{type:"tip",text:"Council members represent different reconstruction priorities: Infrastructure, Defense, Commerce, and Research."},
{type:"tip",text:"Each council vote determines which project gets resources next. You can influence votes through reputation and quest completion."},
{type:"tip",text:"Completed projects permanently improve the Pailune region: rebuilt shops, restored roads, functional fast-travel points, new NPC services."},
{type:"heading",text:"Reconstruction Projects"},
{type:"table",headers:["Project","Category","Cost","Benefit"],
rows:[
["Restore Market Square","Commerce","5k food + 3k timber + 50k Sv","Full merchant hub with rare stock"],
["Rebuild Watchtowers","Defense","3k stone + 2k armaments + 30k Sv","Reduced enemy spawns, map visibility"],
["Repair Bridge Network","Infrastructure","4k timber + 2k stone + 40k Sv","Fast travel restored, shortcut routes"],
["Found Research Wing","Research","2k armaments + 60k Sv","New alchemy recipes, gear blueprints"],
["Reconstruct Housing","Infrastructure","3k timber + 2k food + 25k Sv","New comrade recruits, NPC services"],
["Fortify Walls","Defense","5k stone + 3k armaments + 70k Sv","Siege defense events become easier"]
]},
{type:"warning",text:"Projects take real commitment: thousands of resources + tens of thousands of silver. Start stockpiling during Ch5-6 if you want to hit the ground running."},
{type:"heading",text:"Pailune Institute"},
{type:"tip",text:"The Institute is Pailune's research facility. Functions like Scholastone but focused on reconstruction-related research."},
{type:"tip",text:"Research projects here unlock advanced blueprints: improved Cloudcarts, upgraded ATAG components, and rare alchemy formulas."},
{type:"tip",text:"Institute research requires both resources AND specific dispatched comrades with Engineer or Miner skills. Plan your roster accordingly."},
{type:"heading",text:"Dispatch Integration"},
{type:"tip",text:"Pailune reconstruction missions appear alongside regular dispatch missions. They require more comrades (2-3 per mission) and longer timers."},
{type:"tip",text:"Reconstruction dispatches give massive reputation boosts with the Pailune Council. Prioritize these if you want to influence council votes."},
{type:"tip",text:"Late-game dispatch loop: Run Gorthak armaments + Pailune construction simultaneously. Gorthak feeds resources; Pailune burns them productively."},
{type:"heading",text:"Rewards & Benefits"},
{type:"tip",text:"Fully reconstructed Pailune becomes the best hub in the game: centralized merchants, alchemy station, smithy, fast travel, and unique gear vendor."},
{type:"tip",text:"Council reputation unlocks exclusive rewards: Pailune Officer armor set, Council Signet Ring (+faction rep gains), and Reconstruction Pioneer title."},
{type:"tip",text:"Restored Research Wing provides unique late-game recipes not available anywhere else, including upgraded Palmar Pill variants."},
{type:"heading",text:"Tips"},
{type:"tip",text:"Don't neglect Greymane Camp while focusing on Pailune. Camp dispatches fund Pailune projects — they work in tandem, not competition."},
{type:"tip",text:"Complete all available council side quests before voting sessions. Quest completion shifts council opinion and affects which projects get prioritized."},
{type:"tip",text:"Housing reconstruction = more recruitable comrades in Pailune. Build this early to expand your dispatch roster for everything else."},
{type:"warning",text:"Some reconstruction projects have prerequisites. Repair Bridge Network requires Rebuild Watchtowers first. Check the project tree before committing resources."},
{type:"links",pages:["camp","greymane-camp","dispatch-missions","recruit-comrades","research-institutes"]}
]}
};
