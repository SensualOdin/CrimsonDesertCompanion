...
"gear-refinement":{category:"Gear & Equipment",title:"Gear Refinement & Upgrading",
tags:["refinement","upgrade","blacksmith","bloodstone","abyss artifact","abyss gear","abyss core","grindstone","anvil","turnali","elowen","witch","socket","materials","ore","timber","hide"],
content:[
{type:"intro",text:"Crimson Desert ditches traditional RPG leveling — your power comes almost entirely from gear. Refinement is the primary upgrade system, taking equipment from base stats to double their original power across 10 levels. Neglect it and you'll get two-shot by mid-game bosses. Master it and you'll carve through Pywel like a legend."},
{type:"heading",text:"How Refinement Works"},
{type:"tip",text:"Visit any Blacksmith → select Refinement. Each piece of gear has 10 refinement levels (Lv0–10). Gold ticks on the item icon show current level. Costs materials only — no Silver required."},
{type:"tip",text:"Non-unique gear: refine using gathered materials OR sacrifice an exact duplicate weapon/armor instead of raw materials. Unique gear: requires specific materials only — no duplicate option."},
{type:"tip",text:"Inspect any item → Refinement Information: preview stats at ALL 10 levels before spending anything. See exactly what each upgrade gives you. Exception: accessories (rings, earrings, necklaces) cannot be previewed."},
{type:"warning",text:"Levels 1–4 use cheap standard materials (iron ore, timber, hides). Level 5+ demands Abyss Artifacts — the same currency used for skill unlocks. This is the core mid-game trade-off: skills vs. gear power."},
{type:"heading",text:"Stat Gains"},
{type:"stat",text:"Each refinement level gives +2 to +3 attack (weapons) or defense (armor). Base weapons average 10–15 attack, so Level 5 roughly doubles your damage output."},
{type:"tip",text:"Some gear unlocks secondary stats at higher levels: Critical Rate, Attack Speed, elemental resistance. Accessories may not get their tertiary stat until Refinement Lv3."},
{type:"heading",text:"Materials by Gear Type"},
{type:"table",headers:["Gear Type","Primary Materials","Source"],
rows:[
["Weapons & Plate Armor","Iron Ore, Copper Ore, Scolecite, Bloodstone","Mining (Pickaxe or Force Palm)"],
["Wooden Shields","Timber, Fine Timber, Flawless Timber","Logging (Axe or Turning Slash)"],
["Leather Armor & Jewelry","Thin/Thick/Sturdy Hide, Bones, Fangs","Hunting animals (bigger = rarer drops)"],
["Soft Clothes & Cloaks","Cloth Pieces, Fleece, Feathers","Provisioner's Shop, enemy loot"],
["Level 5+ (all types)","Abyss Artifacts","Combat XP bar, Rumor quests, Sealed Artifacts, Witch shops"]
]},
{type:"tip",text:"Rare materials by region: Bloodstone and Diamond are endgame ores. Gold Ore, Azurite, Garnet, and Epidote appear in mid-to-late regions. Mining nodes respawn over time."},
{type:"tip",text:"Buy Copper + Iron Ore from merchants to stockpile. Always carry a Pickaxe and Logging Axe — mine every deposit you pass while exploring."},
{type:"heading",text:"Blacksmith Locations"},
{type:"table",headers:["Blacksmith","Location","Unlock"],
rows:[
["Turnali","City of Hernand (center north district)","Available from Chapter 1"],
["Tranan","Greymane Camp (Howling Hill)","Camp Lv3 expansion"],
["Regional smiths","Demeniss, Pailune, Delesyia","Story progression"]
]},
{type:"warning",text:"Blacksmiths follow daily routines. They work at forges during daytime — if you arrive at night, rest or wait for them to return."},
{type:"tip",text:"Complete 'Rhett's Request' and 'Turnali's Request' in Hernand (Chapter 1) early to obtain the Pickaxe and Logging Axe for faster material gathering."},
{type:"heading",text:"Abyss Artifacts — Where to Farm"},
{type:"tip",text:"Combat XP bar: yellow gauge left of minimap. Every fill = 1 Abyss Artifact. No cap — grind indefinitely."},
{type:"tip",text:"Greymane Rumor quests: each completed Rumor quest rewards 1 Artifact. Most time-efficient source."},
{type:"tip",text:"Sealed Abyss Artifacts: 141 collectibles in the open world. Pick up → complete the associated Challenge → receive Artifact."},
{type:"tip",text:"Purchases: Secret Shop (Patrigio on roads) and Witch's Lair shops (Chapter 3+) sell Artifacts."},
{type:"warning",text:"Early game: spend Artifacts on skills first. Push gear to Lv4 max. Mid-game: once your skill tree is solid, start pushing key weapons to Lv5+. Late game: farm Gorthak Ironworks (Ch10+) for mass armaments to fund refinement."},
{type:"heading",text:"Abyss Gears & Cores (Socket System)"},
{type:"tip",text:"Abyss Cores are socketable items that slot into gear, granting passive bonuses: attack speed, crit chance, elemental resistance, named abilities like 'Crow's Pursuit' or 'Wind Slash.'"},
{type:"tip",text:"Unlocked after Chapter 5 via the 'Witch of Wisdom' questline. Visit Elowen the Witch at Witch's House in The Witchwoods (Hernand) to start embedding cores."},
{type:"table",headers:["Gear Slot","Max Sockets"],
rows:[
["Two-handed / Ranged weapons","5"],
["One-handed weapons","3"],
["Torso armor","3"],
["Gloves / Boots","2 each"],
["Head armor","1"],
["Off-hand (shields)","2"],
["Cloaks, rings, earrings, necklaces","Cannot socket"]
]},
{type:"tip",text:"Adding sockets costs Silver: 5 → 10 → 20 → 30 → 40 per socket (105 Silver total to fully socket any item)."},
{type:"tip",text:"You can extract cores to move them between gear or swap for better versions. Unique weapons come pre-loaded with Abyss Gears that can be swapped for higher-tier ones as you progress."},
{type:"tip",text:"Every major region has at least one Witch NPC for Abyss Gear slotting — they set up shop on the outskirts of cities."},
{type:"heading",text:"Grindstone & Anvil (Temporary Buffs)"},
{type:"tip",text:"Grindstone: temporarily boosts weapon attack power (+Damage for a set number of strikes). Found at camps, villages, and near smithies."},
{type:"tip",text:"Anvil: temporarily boosts armor defense. Stacks with Grindstone. Found in homesteads and camps."},
{type:"warning",text:"Both buffs are TEMPORARY — they fade over time. Reapply before every major boss fight or liberation zone. The Grindstone at your Personal House (southeast of house) + Anvil at camp are the most convenient."},
{type:"tip",text:"Reinforcement stat: visible when hovering equipped gear. Sharpen/repair at Grindstone/Anvil to maximize this stat for peak performance."},
{type:"heading",text:"Refinement Strategy"},
{type:"stat",text:"Priority order: 1) Primary weapon to Lv4 (cheapest power spike) → 2) Chest armor to Lv4 (biggest defense gain) → 3) Boots + Gloves to Lv3 → 4) Primary weapon to Lv5+ (once Artifact supply is stable) → 5) Shield if you use one."},
{type:"tip",text:"Don't spread materials thin across 12 items. Focus on your main loadout first. A Lv5 weapon + Lv4 armor set outperforms a Lv2 everything build."},
{type:"tip",text:"Weapon type changes Kliff's entire combat stance and move tree. Equipping dual axes unlocks a different moveset than sword-and-shield. Try weapons before investing heavily in refinement."},
{type:"links",pages:["unique-gear-locations","contribution-shops","mining-gathering","camp"]}
]},
...
tags:["unique","gear","locations","treasure","hidden","hwando","hollow visage","lioncrest","sanctum","waterfall","sword of the lord","fallen kingdom","duskfang","dark ringleader","accessories","earrings","necklace","cloak"],
content:[
{type:"intro",text:"Unique gear is scattered across Pywel with no quest markers — behind waterfalls, inside puzzle rooms, under cabins, and locked in manor strongboxes. These items come pre-loaded with Abyss Gears and scale into late game because you can swap their cores for higher-tier ones. This is your treasure map to every piece worth hunting."},
{type:"heading",text:"How Unique Gear Works"},
{type:"tip",text:"Unique weapons/armor come with pre-equipped Abyss Gears providing powerful modifiers and combat abilities. They CANNOT be refined using duplicates — only specific materials."},
{type:"tip",text:"Weapon type changes Kliff's entire combat stance. Dual axes, katana, sword-and-shield, rapier, spear — each unlocks a different moveset. Try before you invest."},
{type:"tip",text:"Gear is NOT locked behind story progress. Almost everything can be collected as soon as you reach its location, regardless of chapter."},
{type:"tip",text:"Loot blends with environment — use Blinding Flash from high ground to spot shining beacons. What looks like decoration may be lootable."},
{type:"heading",text:"Unique Weapons — Early Game (Hernand)"},
{type:"table",headers:["Weapon","Type","ATK","Location","How to Access"],
rows:[
["Sword of the Lord","1H Sword","13","Goldleaf Guildhouse, Unicorn Cliff","Defeat Kailok (Ch2 main quest 'The End of Greed'). First unique with Abyss Gear. Atk Speed Lv2 + Wind Slash."],
["Hwando","2H Sword","19","Lioncrest Manor side building","Buy key from Back Alley Shop (30 Copper). Climb to glassless window → use key on locked door upstairs. Crit Rate Lv1 + Insight I."],
["Hollow Visage","Katana","—","Abyss Nexus near Sanctum of Temperance","Forward stab through waterfall to enter hidden cave. Scales into late game — swap Abyss Gears as you progress."],
["Bekker Axes x2","Dual Axes","—","Underbridge after prologue","Tree stump + nearby rock. Transitional — replace once you reach later vendors."],
["Legionary's Gladius","1H Sword","—","Near Three Saints' Falls, N of Hernand Castle","Light both candles on Statue of Justice along cliff tops → gate opens → chest."],
["Goblin King's Dagger","Dagger","—","Underneath Mudridge Cabin","Break into cabin, search beneath structure, open chest."],
["Volono Sword","Sword","—","Flower bed area with tree stump near water","Navigate to stump, collect from stump."],
["Mining Knuckledrill","Knuckles","—","Marni's Excavation","Complete 'Stolen Quarry' quest (House Roberts) → defeat boss."]
]},
{type:"heading",text:"Unique Weapons — Mid/Late Game"},
{type:"table",headers:["Weapon","Type","ATK","Location","How to Access"],
rows:[
["Tauria Curved Sword","1H Sword","15","Mid-game quest/vendor","Extremely popular due to Crow's Pursuit Abyss Gear. Atk Speed Lv1."],
["Ignir","2H Sword","24","Late-game quest","Highest base ATK unique sword. Crit Rate Lv1 + Destruction I."],
["Melted Ambition","2H Sword","17","Late-game location","Atk Speed Lv2 + Groundsurge. Strong AoE build option."],
["Sorcerer's Staff","Staff","—","Waterfall cave (two rivers converge)","Jump down waterfall → right cave → defeat Grave Walker → light two lamps on door."],
["Fallen Kingdom's Rapier","Rapier","—","Icemoor Castle Ruins cave","Top level → stairs → break wooden planks → enter cave → left side near barrel."],
["Survivor's Solitude","—","—","Behind waterfall E of Scholastone, Lake Kharonso","Follow river upstream → charged stab through waterfall → chest."],
["Fated Shadow","1H Sword","—","Ch9 arena room after Goyen boss","Go backstage → up stairs into cave room → corner."],
["The Golden Sword","Sword","—","Vault of Vengeance, Spire of the Stars","Complete Ch4 Spire challenge → solve Abyss puzzles."],
["Vessel of Dark Pursuit","—","—","Sanctum of Absolution (Ch5)","Defeat sanctuary boss. Wound of Darkness gear."]
]},
{type:"heading",text:"Shields"},
{type:"table",headers:["Shield","DEF","Location","How to Access"],
rows:[
["Rhonid Large Shield","—","Lioncrest Manor","Enter middle window → steal key near tea table → unlock left door."],
["Shield of Betrayal","6","Quest reward","Aegis I + Fortitude I cores."],
["Shield of Conviction","8","Sanctum / quest","Aegis I + Fortitude I cores."],
["Staglord's Shield","6","House Circus questline","Defeat Stag Lord (Ch4, Hernand). Atk Speed Lv2 + Fortification I."],
["Lifsoth Shield","—","Witch's House 2F","Balcony door access."],
["Mirror of Night Shield","—","Sanctum of Atonement","Light both side lanterns → enter building beside right lantern → chest."]
]},
{type:"heading",text:"Best Early Armor"},
{type:"table",headers:["Armor","Slot","DEF","Location","Why It's Good"],
rows:[
["Canta Plate Set","Full set","3–6","Rhett's shop, Hernand Town","Best starter set. All-around attack, defense, attack speed. Tinnitus Immunity. Buy immediately on arrival."],
["Leather Helm FK","Head","3","Sanctum of Benediction","Free Abyss Core with Momentum (+35% Turning Slash Damage). Lightning Res Lv1."],
["Odeck's Protector Boots","Feet","5","Sanctum of Temperance","Two Abyss Core sockets: Aegis II + Haste I. Best early footwear. Stairs → ruins → wall hole → crouch."],
["Plate Gloves FK","Hands","—","Waterfall cave W of Hernand","Pre-loaded Abyss Artifacts (unlock Ch5). Crit Damage + Ice Resistance. Stab through water current to enter."],
["Sunset Reed Cloth Gloves","Hands","1","Boss drop: Reed Devil","Two Abyss Core sockets + Slashing Reed skill. Move Speed Lv1."],
["Blackwing Leather Armor","Chest","12","Crowcaller boss drop (Ch5)","Three Abyss Core sockets. Move Speed Lv1 + Lightning Res Lv1."]
]},
{type:"heading",text:"Hidden Armor & Cloaks"},
{type:"table",headers:["Armor","Slot","Location","How to Access"],
rows:[
["Helm of Ignition","Head","Torchlight Beacon (S Hernand)","Search bedside table inside white tent."],
["Bolton Plate Armour","Chest","Hernand contribution vendor","Increase contribution level → purchase."],
["Duskfang Leather Armor","Chest","Pollengarth Apiary, behind waterfall","Go behind waterfall → cave → open chest."],
["Duskfang Leather Cloak","Cloak","Grace Estate mountain cave","Break wooden gate with axe → open chest."],
["Duskfang Leather Gloves","Hands","Castlewood Ruins","Burn vines → light lamp → open door → chest."],
["Sunset Reed Leather Cloak","Cloak","Castlewood Ruins","Light lanterns on both sides of gate → chest."],
["Hernandian Banquet Cloak","Cloak","Quest reward","Complete Goldleaf Merchant Guild quest."],
["Scholastone Uniform","Full set","Scholastone Institute","Complete 'Price of Knowledge' Ch4 quest → buy rest from Institute merchant."],
["Helm of Knowledge","Head","Scholastone Institute 2F","Left staircase → stone benches in front of bookshelves."],
["St. Hallsius Outfit","Chest","House of Healing","Speak with guard outside door → purchase for 10 Silver."],
["Blackwing Leather Boots","Feet","House of Healing tower (Ch3)","Climb top floor → Blinding Flash → reveal leaf symbol → crouch + Force Palm → hidden floor."],
["Pirate King Hat","Head","Pirate ship Singing Catfish","Explore ship interior carefully."]
]},
{type:"heading",text:"Dark Ringleader Set (Waterfall Caves)"},
{type:"tip",text:"The Dark Ringleader set is scattered across multiple waterfall caves. Each piece requires passing through a waterfall — use Stab/Pierce ability to enter."},
{type:"table",headers:["Piece","Slot","Location"],
rows:[
["Cloth Cloak","Cloak","Echoing Tunnel, behind waterfall"],
["Gloves","Hands","Cloudmist Cave, behind waterfall"],
["Helm","Head","Shadowheart Grotto, behind waterfall"],
["Cloth Armour","Chest","Blade Cavern, behind waterfall"]
]},
{type:"heading",text:"Accessories"},
{type:"table",headers:["Accessory","Type","Location","How to Access"],
rows:[
["Oath of Darkness Earrings","Earrings","Bluemont Manor","Solve owl picture strongbox puzzle (press buttons 4, 1, 2, 3)."],
["Ring of Earth","Ring","Reedfield Graves","Search graves carefully → interact with correct grave."],
["Finely Crafted Gold Necklace","Necklace","Vendor/quest","Available through mid-game vendors or quest rewards."],
["Saint's Necklace","Necklace","Late-game quest","Powerful endgame accessory."],
["Flower Petal Earrings","Earrings","Exploration","Hidden location in overworld."]
]},
{type:"tip",text:"Accessories don't have Abyss Core sockets (cloaks, rings, earrings, necklaces cannot socket cores). Their value comes from raw stat bonuses. You can equip 6 total: rings, earrings, 1 necklace, 1 cloak."},
{type:"heading",text:"Gear Scaling & Progression"},
{type:"stat",text:"Early game (Ch1–3): Canta Plate Set + Sword of the Lord. Grab FK Helm + FK Gloves + Odeck's Boots for a massive Abyss Core advantage before Ch5 even unlocks cores.\nMid game (Ch4–7): Tauria Curved Sword, Blackwing Armor, Scholastone pieces. Start slotting Abyss Cores at Elowen's.\nLate game (Ch8+): Ignir, Fated Shadow, endgame quest rewards. Max refinement on primary loadout."},
{type:"tip",text:"Fallen Kingdom pieces scale into late game because their pre-loaded Abyss Gears can be swapped for higher-tier ones as you progress. Don't discard them."},
{type:"tip",text:"Bolton Armor + Bekker Axes are transitional. Replace once you reach Demeniss vendors and world bosses."},
{type:"tip",text:"Contribution Shops in each major city sell unique gear for Contribution Points (earned from faction quests + liberating areas). Hernand Castle has the first one with better armor than regular vendors."},
{type:"links",pages:["gear-refinement","contribution-shops","exploration-secrets","combat-basics"]}
]},
...
"horses-deep":{category:"Exploration",title:"Horse Taming, Breeds & Trust",
tags:["horse","taming","trust","legendary","drifting","double jump","royler","rokade","camora","saddlery","hespia","priden","brianto","elantrima","numont","breeds","equipment","saddle","horseshoe","stirrups","champron","barding"],
content:[
{type:"intro",text:"Horses are your primary mount for 80% of the game. Wild horses roam every region with randomized stats — taming the right breed and building trust unlocks drift, sprint, combat moves, and breed-specific skills. Equipment from Saddleries dramatically improves survivability. This covers everything: breeds, taming, trust, legendaries, equipment, healing, and management."},
{type:"heading",text:"Horse Breeds"},
{type:"tip",text:"Wild horses have randomized stats within their breed range. Tame multiple to find optimal stat rolls for your playstyle. Purchased horses show stats upfront; wild ones reveal stats after taming."},
{type:"table",headers:["Breed","Tendency","How to Get"],
rows:[
["Hespia","Average all-around starter","First mount after prologue. Limited speed/endurance."],
["Priden","High jump + verticality","Tame in wild. Unique Lv5 skill: High Jump + Double Jump."],
["Brianto","Balanced","Damiane's default (Ch3). Also tame in wild or buy at stables."],
["Elantrima","Speed-focused","Tame in wild or buy at stables."],
["Numont","Stamina-focused","Tame in wild or buy at stables."],
["Dappled Palfrey","Fastest sustained gallop (Spd 85)","Hernand Horse Breeder side quest reward."],
["Desert Charger","Heat resistant, no desert penalty (Spd 80)","Tame in desert outskirts."],
["Greymane Warhorse","Charge attack knockback (Spd 65, Combat 30)","Greymane Faction reputation reward."],
["Midnight Runner","Near-silent movement (Spd 90)","Rare night spawn — any region."],
["Noble Destrier","Increased speed on roads (Spd 75)","Demeniss Royal Stables."],
["Plains Stallion","General purpose (Spd 70)","Starter mount, tame in plains."]
]},
{type:"tip",text:"Harmonious Hooves challenge: ride Priden, Brianto, Numont, and Elantrima for 100m+ each. Check Journal → Mastery."},
{type:"heading",text:"Taming Mechanics"},
{type:"tip",text:"Sprint after wild horse → mount → hold movement toward TAIL direction (opposite horse facing) → fill rope icon before stamina depletes."},
{type:"tip",text:"Camera trick: hold back on stick with camera behind horse = conserves stamina significantly."},
{type:"warning",text:"Cannot eat during taming — eat stamina food BEFORE starting. Fail = thrown off, retry unlimited. Horse doesn't despawn."},
{type:"tip",text:"Legendary horses require 6+ Stamina to tame — they buck harder and drain your bar fast. Upgrade Stamina in Abyss Tree before attempting."},
{type:"tip",text:"Free horses: steal from bandit camps N/NE of Hernand Castle. No taming required but they're temporary unless registered at a stable."},
{type:"heading",text:"Trust Levels 1–5"},
{type:"table",headers:["Level","Skills Unlocked","Details"],
rows:[
["Lv1","Walk + Gallop","Basic movement only. Starting level for all tamed horses."],
["Lv2","Dash","Faster burst speed. Repeatedly press action key to dash."],
["Lv3","Drift + Back Kick","Drift: Hold W+Shift → turn A/D → hold Alt to slide. Back Kick: staggers enemies behind you."],
["Lv4","Sprint","Full sprint speed. Your horse is now reaching its potential."],
["Lv5","Faster swimming + Breed-specific skill","Each breed gets a unique Lv5 skill. Legendaries get special versions."]
]},
{type:"tip",text:"Breed-specific Lv5 examples: Priden → High Jump + Double Jump. Royler → Consecutive Instant Acceleration (double boost after drift)."},
{type:"heading",text:"Building Trust"},
{type:"tip",text:"Three methods — mix all three for fastest leveling:"},
{type:"stat",text:"1) Ride: passive gain from simply riding. 2) Feed: Sugarbeet, Hay, Sugar Cubes (from Saddlery). Max 3 feeds/day for trust gain. 3) Pet: Hold L1/CTRL near horse → Pet prompt. Game NEVER tells you this exists."},
{type:"tip",text:"Freshly tamed legendary horses start at Trust 1 like any other. They need leveling too — don't expect full power immediately."},
{type:"heading",text:"Legendary Horses"},
{type:"table",headers:["Horse","Stats","Location","Taming Tip","Lv5 Skill"],
rows:[
["Royler (White)","Best Speed + Stamina (375+ base)","Lake by Snowgrass Hearth, under 'P' of Pailune on map","Snowy area — equip cold-resist cape or stamina drains fast","Consecutive Instant Acceleration (double boost after drift)"],
["Rokade (Black)","Highest Health, lower speed/accel","Lake near Spire of Insight, Steel Mountains, Grace Estate","No weather penalty but area full of enemies — clear camp first. If not visible, walk 200-300m away and return to respawn","Tanking ability (unconfirmed specifics)"],
["Camora (Red)","Highest Attack + Defense","Redtree Forest by Red River, SE Crimson Desert region","Hot zone — wear heat-resistant gear","Combat-focused (highest rear kick damage)"]
]},
{type:"tip",text:"Royler is the easiest and earliest legendary to obtain. Recommended first legendary — his stamina means you'll rarely stop galloping."},
{type:"tip",text:"Taming all 3 legendaries completes Horse Challenges in Journal → Mastery. Completing all 10 Horse Challenges unlocks 'Tamer of Legends' trophy."},
{type:"heading",text:"Horse Equipment"},
{type:"tip",text:"Five equipment slots — buy from Saddlery shops. Equip ALL slots immediately, even low-tier gear is better than empty slots."},
{type:"table",headers:["Slot","Effect","Priority"],
rows:[
["Saddle","Handling + stamina efficiency","High (exploration)"],
["Horseshoe","Passive stamina regeneration","High (exploration). Shabby Horseshoes = huge for long rides."],
["Stirrups","Rider stability + mounted attack power. Some have +HP regen (Crude Stirrups: +1.0 HP/sec)","High (combat)"],
["Champron","Head/face protection (defense)","Medium"],
["Barding","Body armor — biggest defense reduction. Bought with Contribution Points, not Silver.","High (combat)"]
]},
{type:"heading",text:"Saddlery Locations"},
{type:"table",headers:["Vendor","Location","Notes"],
rows:[
["Annabella's","NE of Hernand","First saddlery. Delmare Saddle + Silver Horseshoe available."],
["NW Hernand vendor","NW of Hernand (unlocked via fishing side quest)","Hernandian Champron + Stirrups."],
["Bruna's","Mid-game region","Standard stock."],
["Eldred's","Pailune","Cold-region equipment."],
["Fiona's","Demeniss","Late-game stock. More items unlock at max merchant trust."]
]},
{type:"tip",text:"Early game: Go SE of Hernand → buy Delmare Saddle + Silver Horseshoe. Then do the fishing quest from Hernand notice board → unlocks NW vendor for Champron + Stirrups."},
{type:"heading",text:"Healing & Recovery"},
{type:"tip",text:"Feed treats or tonics while mounted (long-press Use on food item in inventory). Works during light combat."},
{type:"table",headers:["Item","Effect"],
rows:[
["Hay","Moderate health restoration"],
["Sugar Beet","Small health recovery"],
["Sugar Cubes","Restores weary horse health"],
["Horse Tonic","Pushes health to max, withstand deadly blows"],
["Horse Stimulant","Amplifies stamina to maximum"]
]},
{type:"tip",text:"Signs of injury: visible coat damage, horse sits on grass when summoned. Visit Stable keeper → 'Retrieve and Heal Horse' → pay Copper/Silver based on severity."},
{type:"heading",text:"Combat & Management"},
{type:"tip",text:"Mounted combat fully supported at all trust levels. Drift repositions (Lv3+). Back Kick staggers (Lv3+). Healing Palm (R3→L3) heals horse mid-fight."},
{type:"tip",text:"Stables: buy horses (visible stats), sell tamed horses for profit (good money-making), switch active horse, assign horses to companion characters."},
{type:"warning",text:"Riding ≠ owning. Register horses at a stable to permanently add them to your collection. Unregistered horses are temporary mounts that disappear."},
{type:"tip",text:"Abyss Tree has mount nodes: stamina, speed, health attributes. Different breeds suit different terrain — invest based on your main horse."},
{type:"tip",text:"All three combat mount types (bear, direwolf, raptor) become stronger when rider applies elemental infusions to weapon attacks."},
{type:"links",pages:["fast-travel","traversal","mounts-vehicles","dragon-atag"]}
]},
...
"mounts-vehicles":{category:"Exploration",title:"Vehicles, Wagons & Cloudcart",
tags:["wagon","train","cloudcart","cloudcruiser","skystreaker","balloon","brice","trade","trading post","stolen","wagon fence","emberwind","dispatch"],
content:[
{type:"intro",text:"Beyond mounts, Crimson Desert has a full vehicle system: wagons for trade goods, a craftable hot air balloon (Cloudcart) with two upgrade tiers, trains you can grapple onto, and stolen wagon fencing for criminal profit. Wagons are essential for the trading economy; the Cloudcart is essential for vertical exploration."},
{type:"heading",text:"Wagons — Trading System"},
{type:"tip",text:"Unlock: Upgrade Greymane Camp → recruit Brice the Wagonmaster. Complete 'A Rumor in Glenbright Farm' quest → speak to Brice to start his request."},
{type:"tip",text:"Crafting: Need an Engineer-type Greymane recruit. Speak to Ross → Mission Dispatch → 'Timberturner Wainwright' mission. Bigger wagons = more cargo slots but require more workers, longer craft time, and more resources."},
{type:"tip",text:"Packaging goods: Speak to Karl (Provisions Keeper) at camp → 'Camp Provisions' menu. Costs 100 camp funds per package. Can also press P/L3 to package camp resources (every 1,000 = 1 packed trade good)."},
{type:"tip",text:"Loading: Speak to Brice → 'Load Supply to Wagon'. Move everything you want, then ride out. For small hauls, talk to Stable master to load goods on your horse instead."},
{type:"heading",text:"Selling at Trading Posts"},
{type:"table",headers:["Trading Post","Location","Notes"],
rows:[
["Royal Trading Post","Inside Hernand city","Early access, standard prices."],
["Goldleaf Guildhouse","South of Unicorn Cliff","Minimum 25 stacks per item to sell. Only buys listed items."],
["Regional Posts","Demeniss, Pailune, Delesyia","Better prices for region-specific goods."]
]},
{type:"tip",text:"High-value strategy: Focus on Black Pepper and other rare spices — highest Silver profit per wagon trip."},
{type:"tip",text:"Trade goods sell for more the further you transport them from their origin. Long routes = more Silver but more bandit risk."},
{type:"heading",text:"Stolen Wagons"},
{type:"tip",text:"Steal wagons from roads near trading posts (Royal Trading Post, Goldleaf area). Jump on, drive away. Cannot use stolen wagons for legitimate trade."},
{type:"tip",text:"Sell stolen wagons at Wagon Fences. Earliest: Hernand Wagon Fence, east of Hernand along the Nas River. Found in most regions."},
{type:"warning",text:"Stolen wagons attract guards and bounty hunters. Good money but raises your crime rating."},
{type:"heading",text:"Cloudcart (Hot Air Balloon)"},
{type:"tip",text:"A craftable hot air balloon for vertical ascent — reach otherwise inaccessible elevated areas, then glide to distant locations."},
{type:"stat",text:"Prerequisites: 1) Cloudcart blueprints (hidden in Glenbright Manor secret basement). 2) Discover Emberwind Workshop (Hernand Highlands, south of Greymane Camp). 3) Engineer-type Greymane recruit (unlocks via camp upgrades + Marius recruitment missions)."},
{type:"tip",text:"Craft at Emberwind Workshop once all three prerequisites are met. Dispatch an Engineer on the crafting mission."},
{type:"heading",text:"Cloudcart Upgrades"},
{type:"table",headers:["Variant","Research","Cost","Craft Time","Improvement"],
rows:[
["Cloudcart","Base craft","Camp resources","Dispatch mission","Basic vertical ascent. Limited fuel/duration."],
["Cloudcruiser","Enhanced Cloudcart Efficiency","9 Silver","6 hours","Better fuel efficiency, longer flight."],
["Skystreaker","Enhanced Cloudcart Altitude","100 Silver","18 hours","Top-tier variant. Maximum altitude ceiling."]
]},
{type:"tip",text:"Research unlocked via Scholastone Institute: visit Grunvar (grumpy orc researcher) from Chapter 5 onward → complete his short quest → access Research Requests."},
{type:"warning",text:"Cloudcart has fuel constraints — not infinite flight. Designed for vertical ascent, not long-distance horizontal travel. Use it to reach high points, then switch to glider for distance."},
{type:"tip",text:"Combo: Cloudcart ascent → glider across map = bypass mountains, armies, and walking entirely. Most efficient exploration method in mid-game."},
{type:"heading",text:"Trains"},
{type:"tip",text:"Delesyia railroad tracks have active trains. Grapple onto moving trains to ride across the countryside — no ticket needed."},
{type:"tip",text:"Trains follow fixed routes on a schedule. Useful for traversing Delesyia quickly without a mount. Can fight from train rooftops."},
{type:"heading",text:"Vehicle Priority"},
{type:"stat",text:"Early game: Horse only. Mid game (Ch3-5): Build wagon for trade income + craft Cloudcart for exploration. Late game (Ch10+): ATAG Mech for combat, Dragon for flight. Cloudcart → Skystreaker for maximum altitude."},
...
rows:[
["Black Bear War Mount","80","75","Black Bear faction stronghold","Intimidation roar (3s terrify)"],
["Crimson Grizzly","75","65","Oasis region","Ground slam staggers enemies"],
["Ironhide Cave Bear","90","85","Ironhide Den","Massive HP, acts as a shield"],
["Pailune Snow Bear","85","80","Pailune Mountain caves","Claw/bite + frost resistance aura for rider"]
]},
{type:"warning",text:"Bears are TEMPORARY mounts. Beat into submission until ride prompt appears. They revert to hostile after dismount. No stable registration."},
{type:"heading",text:"Raptors (3) — Fastest Land Combat"},
{type:"table",headers:["Mount","Speed","Combat","Location","Special"],
rows:[
["Sand Raptor","90","40","Red Dunes hunting grounds","Double sprint in deserts. Highest burst speed."],
["Delesyian Swift","85","35","Delesyia Beast Handler (purchase)","Sharp turns without losing speed"],
["Frost Raptor","75","45","Pailune Hunter quest chain","Leaves ice trail, slows pursuers"]
]},
{type:"tip",text:"Mid-game raptors compete with fastest horses for pure mobility. Sand Raptor (Spd 90) matches Midnight Runner horse."},
{type:"heading",text:"Lizards (3) — Terrain Specialists"},
{type:"table",headers:["Mount","Speed","Stamina","Location","Special"],
rows:[
["Rock Lizard","55","80","Hernand Canyon Walls","Can climb vertical surfaces and cliff faces"],
["Sand Skimmer","70","75","Crimson Desert Flats","Glides across dunes, ignores quicksand"],
["Frost Salamander","50","85","Frozen Soul Mountain caves","Immune to ice terrain, cold immunity"]
]},
{type:"tip",text:"Rock Lizard is the only mount that can climb walls — essential for reaching specific collectibles and shortcuts."},
{type:"heading",text:"Dinosaurs (3) — Tanks"},
{type:"table",headers:["Mount","Speed","Combat","Stamina","Location","Special"],
rows:[
["Armored Ankylo","35","80","95","Bone Fields","Tail swipe knocks back all surrounding enemies. Thick plating reduces damage."],
["Steppe Ceratops","50","70","90","Hernand Steppe plains","Horn charge sends enemies flying"],
["Jungle Strider","60","45","80","Hernand Jungle Canopy","Elevated vantage point + kick attack"]
]},
{type:"tip",text:"Dinosaurs are slow but their stamina is enormous. Best for prolonged overland travel where you don't need speed."},
{type:"heading",text:"Dragons & Wyverns (4) — See Above + Others"},
{type:"table",headers:["Mount","Speed","Combat","Location","Special"],
rows:[
["Blackstar Dragon","—","—","Ch11 story reward (see above)","Void breath bypasses all resistances. 15min active / 50min cooldown."],
["Highland Wyvern","80","60","Dragon Ridge Wyvern Egg quest","Full flight control + dive-bomb attacks"],
["Ember Wyvern","75","75","Rare spawn in Volcanic Rifts","Fire breath creates hazard zones"],
["Storm Drake","85","70","Tesla Ruins (storm events only)","Lightning breath with chain damage. Miss the storm = wait for next cycle."]
]},
{type:"warning",text:"Storm Drake only appears during active storm events at Tesla Ruins. Time-limited — if you miss it, you wait for the next weather cycle."},
{type:"heading",text:"Mechanical (3) — Endgame"},
{type:"table",headers:["Mount","Speed","Combat","Stamina","Location","Special"],
rows:[
["ATAG Mech","—","—","—","Ch10 Gorthak (see above)","Full weapons platform. Upgradeable."],
["Scout Automaton","65","40","100","Crafted at Delesyia Workshop","Infinite stamina + built-in lantern"],
...
["Abyssal Spider","60","Abyss Depths (requires Beast Taming skill)","Climb ANY surface + leaves web trail that slows enemies. Most versatile traversal mount."],
...
"camp":{category:"Base Building",title:"Greymane Camp Overview",
tags:["camp","base","greymane","howling hill","expansion","comrades","ross","carl","marius","morale","trust","NPCs","facilities","personal house","alchemy","defense","raids"],
content:[
{type:"intro",text:"The Greymane Camp at Howling Hill is your mercenary headquarters — fast-travel anchor, skill customization hub, and the heart of your progression. What starts as a bare tent grows into a thriving settlement with a farm, ranch, smithy, alchemy lab, workshops, and a full dispatch operation. Neglect it and you'll be severely under-leveled by the 30-hour mark. Master it and you'll lead Pywel's most feared mercenary company."},
{type:"heading",text:"Unlocking the Camp"},
{type:"tip",text:"Unlocks during Chapter 3: Howling Hill — Homestead quest. Reconnect with Marius, receive a fief from Marquis Serkis of Hernand."},
{type:"tip",text:"Complete 'A Fresh Start' (32nd main mission): secure tent → haul supplies → push wagon → plant banner. Cook 2x Modest Clear Soup (tutorial). Escort Marius to camp."},
{type:"tip",text:"Carl and Ross join immediately upon establishment. They are your first two camp NPCs."},
{type:"tip",text:"To trigger expansions: Map → Factions tab → cursor on camp icon → Inspect → Mission List → 'Expand the Camp at Howling Hill.' NOT triggered by NPC or journal."},
{type:"heading",text:"Camp Expansions"},
{type:"table",headers:["Expansion","Requirements","Unlocks"],
rows:[
["Level 2","2 recruits + 100 food + 250 silver + 18h","Dispatch Coordinator (Ross). New recruitment quests."],
["Level 3","More recruits + heavier resources","Smithy (Tranan). Expanded facilities. Alchemy Lab + Dye Station."],
["Level 4","10 recruits + 1,500 armaments + 2,500 stone + 2,500 timber + 4,000 food + 100,000 silver","Farm + Ranch capability. Full workshop access."],
["Pailune Rebuild (Ch7+)","Pailune Council + Pailune Institute","Large-scale reconstruction. Major late-game investment."]
]},
{type:"warning",text:"4th Expansion is brutal. Armaments are the bottleneck — start stockpiling from mid-game. Buy Copper + Iron from the camp weapons merchant early."},
{type:"tip",text:"Camp expansion unlocked after completing the 'A Gentle Touch' main quest in Chapter 3. Each expansion visually evolves the camp and provides gameplay benefits."},
{type:"heading",text:"Key NPCs"},
{type:"table",headers:["NPC","Role","Details"],
rows:[
["Carl","Provisions & Supply Chest","Collects dispatch rewards + missed loot (230-slot max). Manage Supplies → Support Camp Resources → donate funds/items to boost camp growth."],
["Ross","Comrade Manager & Dispatch Coordinator","Helmet icon on map. One-stop mission hub for all dispatch assignments. Unlocks at Camp Lv2."],
["Luke","Dispatch Assignments","Handles direct dispatch assignments. Check recruit skill profiles before sending."],
["Marius","Camp Expansion","Assigns camp expansion objectives and guides progression."],
["Lonnie","Cook","Free Chewy Rice Cakes + Porridge daily (resets). Sells ingredients, prepared dishes, and recipes. Unlocked via 'A Rumor at Glenbright Farm.'"],
["Tranan","Blacksmith","Buys/sells gear + ammo + refinement items. Unlocked at Camp Lv3."],
["Brice","Wagon Master","Timberturner Wainwright missions → unlock trade wagons. Requires Engineering-skill recruit."],
["Naira","Pets & Dyes","Side quests unlock pets and color dyes for Kliff."],
["Yann","Royal Trading","Introduces the Royal Trading system for high-value trade routes."]
]},
{type:"tip",text:"Cook + Quartermaster unlock together via 'A Rumor at Glenbright Farm' mission. Do this early — cooking is non-negotiable since food is your only healing source."},
{type:"heading",text:"Camp Facilities"},
{type:"tip",text:"Personal House: rest to advance time (speeds dispatch timers + crop growth), alchemy crafting, decoration. Physically place furniture and props by hand. You must push the wagon and raise the banner before the cottage appears on your map."},
{type:"tip",text:"Grindstone (southeast of house): sharpen weapons for temporary attack boost (+Damage for a set number of strikes). Use before every major boss fight."},
{type:"tip",text:"Anvil (near smithy): boost armor defense temporarily. Stacks with Grindstone. Both effects are temporary — reapply before each hard encounter."},
{type:"tip",text:"Alchemy Lab: unlocked via 'Restore the Greymane Camp' quest + camp materials (wood from Logging, ore from Mining in Hernand). High-value — Attack Speed Potion (+30% for 60s) and Palmar Pills (self-revive on death) transform difficult fights."},
{type:"tip",text:"Dye Station: unlocked slightly later through a life skills quest chain. Cosmetic-only — prioritize Alchemy Lab first."},
{type:"tip",text:"Cooking Pot: cook dishes using gathered ingredients. Food can be eaten mid-combat with no cooldown. Dishes provide HP regen, temporary combat buffs, and passive bonuses."},
{type:"tip",text:"Smithy (Tranan): refine weapons/armor up to 10 levels. Levels 1–4 are cheap (standard materials). Level 5+ demands Abyss Artifacts. You can sacrifice a duplicate weapon instead of spending materials."},
...
{type:"tip",text:"Klinden Workshop: produce Kuku Pots for storing puzzle pieces and machinery parts."},
{type:"tip",text:"Trading Center: convert provisions into packaged trade goods via Carl. Monitor regional prices for profit."},
{type:"heading",text:"Morale & Trust System"},
{type:"warning",text:"Your mercenaries are living entities with needs. They demand daily wages (Silver auto-deducted), cooked food, and ale. If Morale drops below 20%, companions will abandon camp in the middle of the night."},
{type:"tip",text:"Maintain morale: keep camp well-supplied with food, upgrade tents (sleeping in rain tanks morale), win battles, complete dispatch missions successfully."},
{type:"tip",text:"Trust is built through sharing meals at camp, giving gifts, completing companion-specific quests, and making choices that align with Greymane values."},
{type:"tip",text:"High-trust companions: better dispatch yields, stronger combat support, unlock personal backstory content, better trade prices, and share rumors about hidden locations."},
{type:"tip",text:"At max trust, companions offer a unique Loyalty Quest. Completing it permanently unlocks their ultimate combat ability (e.g., Elara's Rain of Arrows, Silas's Mass Resurrection) and guarantees they never desert — even if morale drops."},
{type:"tip",text:"Echoes of the Past: at certain trust thresholds, companions unlock playable flashback missions revealing how the Greymanes first formed. Triggered by sharing meals or drinks at high trust."},
{type:"heading",text:"Companion Permadeath"},
{type:"warning",text:"Permadeath is real. If a companion falls in battle, they enter a Downed state with a brief bleeding-out timer. Reach them in time to revive with a bandage or healing spell. Fail and they die permanently."},
{type:"tip",text:"Keep healing items stocked. Position yourself near struggling companions during large fights. Losing a high-trust companion means losing their dispatch skills, combat abilities, and quest lines forever."},
{type:"heading",text:"Camp Defense"},
{type:"tip",text:"As reputation grows, rival mercenary bands and enemy factions launch raids on your camp. Upgrade Barracks and outfit NPC crew with better gear to defend successfully."},
{type:"tip",text:"Crime near camp hurts Hernandian Contribution reputation and disrupts supply lines. Keep your nose clean around Howling Hill."},
{type:"heading",text:"Greymane Commissions"},
{type:"stat",text:"27 total Greymane Commissions. Each rewards Medium Bag (+3 inventory slots) = up to +81 slots total."},
{type:"tip",text:"MANDATORY for comfortable late-game inventory management. Run these as soon as they appear — they also boost Trust with the requesting companion."},
{type:"heading",text:"Faction Quest Categories"},
{type:"tip",text:"Scattered Embers: side quests from Naira, Yann, Oongka. Unlock after story progression."},
{type:"tip",text:"Grounds of the Sunrise: camp expansion projects and survivor locations. Look for quests starting with 'A Rumor...' — these lead to old comrades."},
{type:"tip",text:"Greymane Commissions: material/weapon requests from camp residents. 27 total, each rewarding inventory expansion."},
{type:"heading",text:"Priority Checklist"},
{type:"stat",text:"Priority order: 1) Cooking Pot (food = healing) → 2) Alchemy Lab (potions are game-changers) → 3) Blacksmith Forge Lv2 (Tier 3 weapon reinforcements) → 4) Barracks (recruit higher-tier NPCs) → 5) Farm + Ranch (self-sufficient food) → 6) Dye Station (cosmetic)."},
{type:"tip",text:"Recruit scattered Greymanes ASAP — more comrades = more dispatch slots + camp features + defense strength."},
{type:"tip",text:"Buy Pickaxe + Logging Axe early from Provisioner's Shop in Hernand. Gather every deposit you pass while exploring. Force Palm Attack and Turning Slash can substitute for tools in a pinch."},
{type:"links",pages:["greymane-camp","cooking-recipes","faction-quests","trading-wagons","mining-gathering"]}
]},
...
tags:["exploration","secrets","hidden","blinding flash","sealed abyss artifact","treasure","strongbox","puzzle","hidden bells","caves","waterfall","mysterious energy","kuku pot","ancient ruins","cresset","treasure map","collectibles","visione"],
content:[
{type:"intro",text:"Pywel is layered with hidden content — secret caves behind waterfalls, treasure maps with no markers, destructible rubble hiding entire dungeons, and 141 Sealed Abyss Artifacts scattered across the continent. The key tools for uncovering everything are Blinding Flash, the Visione, your Lantern, and a willingness to interact with anything that looks even slightly out of place."},
{type:"heading",text:"Blinding Flash — Your Discovery Tool"},
{type:"tip",text:"Unlocked automatically in the Prologue when you first visit the Abyss. Free skill — no cooldown, no stamina cost. One of the most important abilities in the game."},
{type:"tip",text:"Controls: PC = hold CTRL + Left Click simultaneously. Controller = tap L1+R1 (PS) / LB+RB (Xbox) to enter reflection stance, release both, then press and hold L1/LB to aim."},
{type:"tip",text:"POI Locator: use Blinding Flash while exploring (even while mounted) to mark nearby locations with glowing Blue Light. These mark Abyss Artifacts, puzzles, collectibles, and Abyss Nexuses (fast travel points)."},
{type:"tip",text:"Mysterious Energies: using Blinding Flash in the open world reveals glints of light at the horizon. Open your map after spotting a glint — a new question mark icon appears. Always investigate these — rewards are always worth the detour."},
{type:"tip",text:"Vine burning: aim Blinding Flash at vines blocking pathways or hiding collectibles. Works the same as aiming at puzzle light sources."},
{type:"tip",text:"Light Puzzles: in Ancient Ruins, cast Concentrated Light on specific runestones to open barred passages. Charge targeted devices until you get an audio/visual cue confirming activation."},
{type:"tip",text:"Combat use: momentarily blinds enemies, interrupts actions, immobilizes groups. Blinding Flash Finisher (unlockable) follows up with a barrage of strikes — final hit sends weaker enemies flying."},
{type:"heading",text:"Hidden Bells (Toll of Pywel)"},
{type:"stat",text:"8 Hidden Bells across Pywel. Ringing all 8 reveals the full world map including road outlines."},
{type:"warning",text:"Activate ALL bells first before hunting collectibles. Since every Sealed Abyss Artifact sits on a road, unfogging the map makes finding them dramatically easier. Grab fast travel points along the way."},
{type:"heading",text:"Sealed Abyss Artifacts"},
{type:"stat",text:"141 total. Required for 100% completion, Platinum trophy, and 1000 Gamerscore. Each is tied to a specific Challenge — pick one up and it enters your inventory locked until you meet its requirement."},
{type:"tip",text:"How to find: not marked on the main map but appear as purple icons on the minimap when nearby. Most are placed atop stone altars along roads."},
{type:"tip",text:"Detection tricks: hold up your Lantern while riding — Sealed Artifacts emit white light from a distance. Blinding Flash also reveals nearby artifacts with blue glimmers."},
{type:"tip",text:"Rewards: Abyss Artifacts (skill points), Faded Abyss Artifacts (skill reset currency), and Abyss Gears (weapon/armor mods)."},
{type:"warning",text:"Collect artifacts as early as possible. Most challenge progress does NOT count retroactively — requirements only track after you pick up the artifact."},
{type:"tip",text:"Tracking: picking up an artifact reveals its Challenge in the Challenge menu. Compare your menu against guide lists to find what's missing — menu uses a fixed order for easy comparison."},
{type:"table",headers:["Region","Key Artifact Areas"],
rows:[
["Hernand (starting)","Highest concentration. Roads around Hernand Town, Goldleaf Trading Post, Calphade, northern watchtowers."],
["Demeniss (east)","Roads connecting Stonewell Farm, Ironwood Farm, Spire of Clockwork."],
["Pailune (north)","Near town center, Skoghorn, Torvak Camp, River Breeze Hearth."],
["Delesyia (west)","Delesyia South Gate, Windrose Farm, Redfox Trading Post, Chittering Forest."]
]},
{type:"heading",text:"Ancient Ruins & Abyss Cressets"},
{type:"tip",text:"Ancient Ruins contain puzzles that activate Abyss Cressets (fast travel points) and yield Abyss Artifacts. Track discovered ruins via Journal → Challenges → The Thread in the Forest."},
{type:"tip",text:"Puzzle types: rotating statues, symbol-matching devices, mural deciphering, checkerboard stone placement, piston/cylinder height adjustment, light-beam reflection with crystals."},
{type:"tip",text:"Light reflection: at Glenbright Manor, spin the chandelier until its beam hits a crystal statue's sphere → hidden wall panel opens revealing the Sapphire-Hilted Golden Dagger."},
{type:"tip",text:"Environmental clues: green leaf particles = Fusion Reactor Core correctly placed. Glowing energy streams = pipe connections aligned. Audio cues confirm correct placements."},
{type:"tip",text:"Use the Visione near puzzle sites to highlight interactable objects and reveal hidden paths you might miss visually."},
{type:"heading",text:"Treasure Chests"},
{type:"table",headers:["Chest Type","Contents","Count","Notes"],
rows:[
["Strongbox","Rare recipes, unique weapons, accessories","7","Require built-in puzzles. Contents count as stolen — must wear Mask to take items."],
["Treasure Chest","Armor, equipment, Palmar Pills","6","Quest-locked or location-specific. One-time only."],
["Regular Chest","Money, crafting materials","5+","Found in forts, settlements, caves. Lower-tier."]
]},
{type:"tip",text:"Strongbox locations: Bluemont Manor x2 (owl picture puzzle + piston puzzle), Hernand Castle (melody puzzle — crank dial, listen, reproduce), Church of West Demeniss (light puzzle), Hillside Manor, Lioncrest Manor (climb in through window), Mudridge Cabin (sliding puzzle)."},
{type:"tip",text:"Respawning: basic resource chests in bandit camps respawn after ~1 in-game week. Unique collectible chests, Pywelian Relics, and Ancient Obelisks are one-time only."},
{type:"heading",text:"Hidden Treasure Maps"},
{type:"tip",text:"Treasure Map pieces are scattered with NO map markers or quest indicators — pure exploration rewards. First map piece: white tent on north side of Demeniss → leads to a cave beside a waterfall where two rivers intersect."},
{type:"tip",text:"Some treasures require special items (Visione Helmet) or abilities (Pierce attack to pass through waterfalls). Come prepared with healing items and Abyss abilities."},
{type:"heading",text:"Secret Caves & Hidden Areas"},
{type:"tip",text:"Waterfall caves: walk behind waterfalls or use Stab/Pierce to pass through. Ancient's Heart Cave (behind waterfall) = Vaporwalker unique boots + Refined Palmar Pill."},
{type:"tip",text:"Destructible rubble: controller vibrates near a dead-end cave wall? Use Axiom Force (Telekinesis) to pull loose rocks away — reveals hidden dungeon entrances."},
{type:"tip",text:"Crow circles: a flock of black crows circling a rock formation or canyon = high chance of an Ancient Obelisk or hidden cave entrance directly beneath."},
{type:"tip",text:"Wind audio cue: distinct 'howling wind' in mountain ranges = strong updraft. Use Air Dash/Glider to reach otherwise inaccessible peaks."},
{type:"tip",text:"Karin Quarry underground: after clearing bandits + extracting Relic via crane, drop into the hole. Find Palmar Pills → destroy sentry constructs for Power Cores → Focused Force Palm (charge to golden orb) to break magical wall → Abyss Transporter behind it (seal in Kuku Pot)."},
{type:"tip",text:"Nature's Grasp (Circle + Triangle): opens secret walls in Sanctums. Used at Sanctum of Veneration for basement access containing Fusion Reactor Core: XIII."},
{type:"heading",text:"Kuku Pot"},
{type:"tip",text:"Unlocked early Chapter 3 via 'Mysterious Pot' quest. A Dwarven device that stores objects many times larger than itself — essential for sealing Abyss Transporters and puzzle components."},
{type:"tip",text:"Repair 3 kilns at Kilnden Workshop: 1) Reconnect pipe + activate levers. 2) Lift broken pieces with Axiom Force (L3), rotate to fit, Aerial Force Palm to fuse. 3) Find electrified fuel orbs nearby. Talk to Grimnir → pull yellow lever → receive Kuku Pot."},
{type:"heading",text:"Essential Abyss Abilities for Exploration"},
{type:"table",headers:["Ability","Exploration Use"],
rows:[
["Blinding Flash","Reveal POIs, solve light puzzles, burn vines, combat stun"],
["Force Palm","Break unusual objects, substitute for Pickaxe, fuse kiln pieces"],
["Axiom Force (Telekinesis)","Move heavy objects, clear rubble, lift puzzle components"],
["Nature's Grasp","Open secret walls in Sanctums and hidden areas"],
["Stab / Pierce","Pass through waterfalls, activate puzzle mechanisms"],
["Visione","Highlight interactable objects near puzzle sites"]
]},
{type:"heading",text:"General Tips"},
{type:"tip",text:"'Decorations' in camps, sheds, and bandit outposts may be lootable. Interact with anything that glows or looks out of place."},
{type:"tip",text:"Ice arrows create water platforms for crossing gaps. Experiment with elemental arrows near water."},
{type:"tip",text:"Weather matters: sandstorms, fog, and blizzards affect visibility + combat, and may reveal or hide certain secrets."},
{type:"warning",text:"Some regions become temporarily or permanently inaccessible after major story sieges. Explore regions thoroughly BEFORE advancing main questline battles."},
{type:"tip",text:"Interactive maps available on Steam Community, Gamer Guides, and GameMappers — track collectibles, mark completed objectives, systematically clear each area."},
{type:"links",pages:["fast-travel","traversal","side-activities","challenges"]}
]},
...
"side-activities":{category:"Side Content",title:"Life Skills & Side Activities",
tags:["fishing","hunting","mining","gathering","horse taming","life skills","cooking","alchemy","logging","woodcutting","rod","legendary fish","legendary horse","pelts","hides","herbs"],
content:[
{type:"intro",text:"Crimson Desert has six life skills — Fishing, Hunting, Gathering, Mining, Cooking, and Alchemy — plus Horse Taming. These aren't fluff. They feed directly into gear upgrades, camp resources, cooking (your only healing source), and your economy. Side content accounts for 100–180 hours on top of the 40–60 hour main story, and rewards critical items like inventory slots, Abyss Artifacts, and unique gear you can't get any other way."},
{type:"heading",text:"Fishing"},
{type:"tip",text:"No bait needed — just a rod and water deep enough to cast. Most rivers, lakes, and coastal areas work. Stand at the very edge of the water so your hook doesn't snag the ground."},
{type:"tip",text:"How to fish: hold L2/LT to cast → wait for three distinct splashes → hold L2 to hook → angle rod OPPOSITE the fish's movement → only reel (right stick) when the water is calm. Stop reeling if it thrashes or the line snaps."},
{type:"table",headers:["Rod","How to Get","Notes"],
rows:[
["Basic Fishing Rod","Free — south of Hernand by river boxes, or observe NPCs fishing after Kliff exits the Abyss","Works for all regular fish. Do NOT sell your free life tools."],
["Fine Fishing Rod","10–15 Silver from back alley shop south of House of Healing","Minor speed boost. Not worth the cost early on."],
["Porin Fishing Rod","Unlocked via research + camp dispatch missions","Required for legendary fish. Regular rods may not hook them at all."]
]},
{type:"tip",text:"Bare-hands fishing: swim into shallow water and hold X to grab fish directly. Fast for quest items but can't catch legendaries."},
{type:"stat",text:"~51 fish species: 26 freshwater + 13 saltwater + 5 legendary. Find discovered species via Knowledge tab → Creatures → Aquatic Creatures → Open Map for exact locations."},
{type:"tip",text:"Hover over fish at vendor stalls to unlock Knowledge entries for species you haven't caught yet."},
{type:"tip",text:"5 legendary fish (Clockwork Fish, Cola Camp, Golden Carp, Golden Collar Camp, Golden Tench): require Porin rod, multiple reel phases, patience. Each sells for ~10 Silver + progression rewards."},
{type:"tip",text:"Keep fish whole for cooking — most recipes use the whole fish. Cleaning yields Fish Fillet + bonus items like Abyss Cores. Cooked fish sells for significantly more than raw."},
{type:"tip",text:"Fishing is danger-free and one of the best early-game money makers. Feed fish to stray cats to adopt them as pets."},
{type:"heading",text:"Hunting"},
{type:"tip",text:"Hunt wild animals for meat, Thin/Thick/Sturdy Hide, Short/Long Hair Hide, furs, and horns. All feed into cooking, crafting, and camp resources."},
{type:"stat",text:"11 Hunting Challenges (Life Category). Completing all unlocks the Ultimate Hunter trophy/achievement. Each is unlocked by finding a Sealed Abyss Artifact in the world."},
{type:"tip",text:"Example: 'Feather of the Earth' — find the Sealed Abyss Artifact at Karin Quarry (south side of road, NW of rest area). Requires carrying 5 birds."},
{type:"tip",text:"Rewards include Abyss Artifacts (used to learn/enhance skills and boost core stats) and Blessing of the Beast I."},
{type:"tip",text:"Legendary animals: some are huntable, others are tameable mounts (like legendary horses). Press Open Map after discovering one to see its exact location. The Vine Deer changes appearance with seasons — check antlers for flowers."},
{type:"tip",text:"Force Palm Lv3 is useful for dealing with herds. Unfog the map first by activating the 8 Hidden Bells — makes locating hunting challenges and collectibles much easier."},
{type:"heading",text:"Gathering & Mining"},
{type:"tip",text:"Buy Pickaxe + Logging Axe early from Provisioner's Shop in Hernand. Having both lets you gather any deposit you find while exploring."},
{type:"tip",text:"Force Palm Attack substitutes for Pickaxe. Turning Slash substitutes for Logging Axe. Handy if you forgot your tools, but slower."},
{type:"tip",text:"Mining: extract ores, minerals, and gemstones from nodes in caves, mountains, and ruins. Essential for weapon upgrades and gear crafting. Iron farming starts in Akapen region."},
{type:"tip",text:"Logging: physically chop trees for timber. Timber is a core camp expansion resource."},
{type:"tip",text:"Gathering: herbs, plants, fungi (Reagents for alchemy), food ingredients. Physically pick items from the environment."},
{type:"warning",text:"Gathering tools become blunt over time and must be replaced. Buy spares or keep crafting materials on hand."},
{type:"heading",text:"Horse Taming"},
{type:"tip",text:"Find wild horses roaming the map (especially river areas east and south of Hernand). Sheathe your weapon → approach → press ride to start taming mini-game."},
{type:"tip",text:"Taming: a circle appears showing taming progress. Pull Left Stick OPPOSITE the horse's direction. Hold camera behind the horse and hold back — keep the camera on its tail as it spins."},
{type:"warning",text:"Hidden time limit — if you take too long, you get thrown. You can't eat during taming. If you fail, get up and try again (unlimited attempts)."},
{type:"tip",text:"Riding ≠ owning. You must register horses at a stable to permanently add them to your collection. Unregistered horses are temporary mounts."},
{type:"tip",text:"Sell tamed horses at stables for Copper/Silver. Poor-stat horses are worth selling to try again. Good money-making activity."},
{type:"table",headers:["Legendary Horse","Location","Special Stat","Taming Tip"],
rows:[
["Royler (White)","Lake by Snowgrass Shelter, Silver Wolf Mountain, Pailune","Best stamina","Cold region — dress warm"],
["Rokade (Black)","Steel Mountains region","Highest health","Easiest to tame — no weather penalties"],
["Camora (Red)","Redtree Forest, Tashkalp (south)","Balanced","Hot region — wear heat-resistant clothes"]
]},
{type:"tip",text:"Need 6+ Stamina for legendary horses. Alternative: steal horses from bandit camps north/NE of Hernand Castle — free and easy."},
{type:"tip",text:"Horse trust ranges from 1–5. Increase by riding, petting (Lantern button → Pet), and feeding. Higher trust unlocks new movement and combat abilities."},
{type:"heading",text:"Cooking & Alchemy (Overview)"},
{type:"tip",text:"Cooking is non-negotiable — food is your only healing source, usable mid-combat with no cooldown. Dishes provide HP regen, temporary combat buffs, and passive bonuses. Fish Porridge (known from start) restores Health."},
{type:"tip",text:"Alchemy uses Reagents (bugs, plants, fungi) + Catalysts (iron ore, spider webs, hide — quality determines potion strength) + Containers (empty bottles from Provisioners — buy in bulk)."},
{type:"tip",text:"Priority potions: Attack Speed Potion (+30% for 60s), Palmar Pills (self-revive on death). Both are game-changers for hard fights."},
{type:"tip",text:"Most recipes must be found while exploring or completing missions. Some unlock through main story, others are hidden. Check the Alchemy Lab at Greymane Camp."},
{type:"heading",text:"Time Estimates"},
{type:"stat",text:"Main story: 40–60 hours. Side content: 100–180 hours. Full completion (all challenges, collectibles, 430+ quests): 200+ hours."},
{type:"tip",text:"141 Sealed Artifact challenges total. Elowen's 4 Sanctums → Kuku weapons. Regional commissions → inventory slots (+3 per commission, 27 total = +81 slots)."},
{type:"links",pages:["minigames-crime","camp","cooking-recipes","mining-gathering"]}
]},
"minigames-crime":{category:"Side Content",title:"Minigames, Bounties & Crime",
tags:["duels","boxing","wrestling","spear","archery","shooting","gambling","duo","five-card","arm wrestling","bounty","bounties","crime","stealing","pickpocket","mask","wanted","jail","minigames","rock paper scissors"],
content:[
{type:"intro",text:"Pywel is packed with minigames that reward Silver, reputation, unique prizes, and trophies. From fistfights in underground arenas to high-stakes card games in smoke-filled taverns, these activities are both lucrative and mechanically distinct from main combat. Plus, if you're feeling less honorable, there's a full crime system with stealing, pickpocketing, and consequences."},
{type:"heading",text:"Combat Duels"},
{type:"tip",text:"5 Duel Challenges total (Minigame Category). Completing all Minigame sub-categories unlocks the True Gamer trophy/achievement."},
{type:"tip",text:"First duel unlocks automatically in Chapter 4: The Price of Knowledge → Daily Life → 'Disturbance at the Arena' main quest."},
{type:"warning",text:"Duels have strict rules. Using prohibited weapons, Axiom Powers, or non-compliant attack styles = instant disqualification. Entry fees are forfeited if disqualified."},
{type:"table",headers:["Duel Type","Location","Buy-In","Rules & Tips"],
rows:[
["Unarmed Boxing","Goldenfist Arena","30 Copper","Fists only — no kicks, sweeps, or body slams. Unequip all weapons. Lock on, sidestep laterally (don't backstep), block if dodges fail."],
["Spear Duel","City of Hernand","45 Copper","Spear-only. Master distance control. Be aggressive — don't let opponents start long combo strings. Dodge forward past sweeping attacks."],
["Wrestling","Kharonso","1 Silver","Grapple moves only. Sloppy inputs or accidental basic strikes = instant disqualification. Stick to safe moves: Lariats and throws."],
["Bow Contest","Lioncrest Manor","80 Copper","Race to hit 10 pop-up wooden targets before opponent. Crank camera sensitivity + acceleration to max for faster target snapping."],
["Gun Contest","City of Hernand","1 Silver","Same format as Bow — first to 10 targets wins. Speed + accuracy under pressure."]
]},
{type:"tip",text:"Champion system: win 3 consecutive matches to force the local champion to enter the pool. Defeat the champion for unique prizes. Warning: beating a champion permanently closes that venue — you can never participate there again."},
{type:"tip",text:"Consecutive victories boost rewards. Save before attempting streaks."},
{type:"heading",text:"Gambling: Duo & Five-Card"},
{type:"tip",text:"Duo: receive 5 sticks (cards) with numbers + colors (yellow/red). Game auto-combines 3 into a sum of 10/20/30. Remaining 2 form your 'Duo' hand. No valid combination = Bust (auto-lose)."},
{type:"table",headers:["Duo Hand","Ranking"],
rows:[
["Ten Pair (both sticks are 10s)","Strongest — automatic win"],
["Pair (matching numbers 1–9)","Higher pairs beat lower pairs"],
["Perfect Nine (two sticks sum to 9)","Strong"],
["Points (sum to single digit, not 9)","Moderate"],
["Bust (no valid combination)","Auto-loss"]
]},
{type:"tip",text:"Five-Card (Beighen only, 150 Silver): color matters. Prime Pair (red 3 + red 8) = guaranteed win. Superior Pair (red 1 + red 3/8) is next strongest. Special hands (Warden, High Warden) can trigger rematches."},
{type:"table",headers:["Location","Game","Buy-In"],
rows:[
["City of Hernand (tavern, 1st floor)","Duo","15 Silver"],
["Tomasso (northeast)","Duo","300 Silver"],
["Beighen (northern region)","Five-Card","150 Silver"]
]},
{type:"tip",text:"Cheating: after observing an opponent with blue outline 3 times, unlock Cheat ability. Activate only when dealing — hold Hide Hand prompt to select a specific number/color. Target red 3 or red 8 in Five-Card for Prime Pair path."},
{type:"warning",text:"You can accuse opponents of cheating. Correct = they're removed from the match. Wrong = you're banned from the gambling den for ~2 in-game days."},
{type:"tip",text:"Save-scum strategy: manual save outside the gambling den before entering. Go all-in early with strong hands — AI tends to call all-in bets even with weak cards. Reload on losses."},
{type:"heading",text:"Other Minigames"},
{type:"tip",text:"Arm Wrestling: found in taverns. Button-mash QTE — press Square/X rapidly to fill gauge red. Wager doubles if you win, lost if you lose. Unlocked via 'Where Rumors Gather' quest."},
{type:"tip",text:"Rock Paper Scissors: City of Hernand. Win 2 of 3 rounds. 23-hour in-game cooldown between plays. Save-scum friendly."},
{type:"tip",text:"Archery Contest at Lioncrest Manor is repeatable and one of the best early-game money sources."},
{type:"heading",text:"Outlaw Bounties"},
{type:"tip",text:"Unlocked after Chapter 2. Purple letter icons on minimap mark bounty notices on bulletin boards in towns, settlements, and roadsides."},
{type:"tip",text:"Process: read notice → target marked on map → travel to location → chase and tackle (Circle/B) → punch until tie-up prompt appears → tie them up → call horse → stash bounty on horseback → ride to Guard Station (west of Hernand walls)."},
{type:"warning",text:"Capture alive = full reward. Kill = HALF Silver reward. Alive also gives hefty Contribution EXP boost. Always try to capture alive."},
{type:"tip",text:"Example: Blix bounty — alive: 15 Silver + 200 House Celeste Contribution EXP. Dead: 7.50 Silver + 200 Contribution."},
{type:"tip",text:"No fast travel while carrying bounties. Long rides back from remote areas. If horse takes too much damage or bucks, you and the bounty fall. Dismount and carry on foot through impassable terrain, then resummon horse."},
{type:"warning",text:"Do NOT save/reload while transporting — Kliff may spawn at a different location and you'll have to recapture the target."},
{type:"tip",text:"Tied bounties can struggle free. Keep moving — don't stop to fight random enemies while transporting."},
{type:"tip",text:"Guarded targets: pull guards away with Bow, kite defensively, isolate the target. Run away until they de-aggro, then sneak up from behind."},
{type:"tip",text:"9 bounties in starting Hernand region. The 9th bounty poster appears near Equinsher Saddlery in Chapter 8."},
{type:"tip",text:"House Celeste runs the bounty board — one of the most rewarding faction pools. Warren is the highest-paying bounty at 25 Silver."},
{type:"heading",text:"Crime System"},
{type:"warning",text:"Must wear a Mask to steal. Without one, the Steal prompt is greyed out. Buy a mask from Back Alley Shop in Hernand for 10 Copper, or get one from the Jeffrey bounty quest in Chapter 2, or loot from bandits."},
{type:"table",headers:["Crime Type","How It Works","Penalty"],
rows:[
["Stealing (chests/shelves)","Hold Lantern near container → Steal prompt","-5 regional reputation (even undetected)"],
["Pickpocketing","Sprint into NPC → button prompt (guards can't be pickpocketed)","-5 regional reputation + risk of detection"],
["Wagon/Livestock Theft","Hijack wagons → sell to Wagon Fence NPC. Steal livestock → sell at Livestock Black Market","Reputation loss + guard response if witnessed"],
["Vandalism","Riding through fences, smashing objects near NPCs","Crime zone trigger"],
["Murder","Attacking civilians/guards","-30 Contribution — massive penalty"]
]},
{type:"tip",text:"Crime detection: red AoE circle appears around theft location. NPCs/guards in that radius witness the act and may alert guards. Stealing in private with no witnesses = small rep loss only, no guard response."},
{type:"tip",text:"Getting caught by guards: brutal QTE to escape. Fail = jail + bounty deducted from wallet + massive fine. Surrendering peacefully = fine only (cheaper than fighting and losing)."},
{type:"tip",text:"Regional tracking: crimes are tracked per-region. Misdeeds in Hernand don't follow you to Varnia."},
{type:"tip",text:"Severe criminal reputation: NPCs may ignore you or run away, blocking shops and quest access in that region."},
{type:"heading",text:"Clearing Wanted Status"},
{type:"tip",text:"Evasion: for minor crimes, sprint out of the red threat zone and hide in wilderness. Aggro drops naturally."},
{type:"tip",text:"Church Absolution: visit any church → select Writ of Absolution → pay fine. Cleanest fix for serious crimes."},
{type:"tip",text:"Reputation recovery: complete 1–2 side quests in the region or donate to beggars. The per-crime rep loss is small and manageable even after multiple thefts."},
{type:"heading",text:"Side Content Tips"},
{type:"stat",text:"141 Sealed Artifact challenges total. Elowen's 4 Sanctums → Kuku weapons. Regional commissions → +3 inventory slots each (27 total = +81 slots). These are not optional for late-game comfort."},
{type:"tip",text:"Crime near Greymane Camp hurts Hernandian Contribution reputation AND camp supply lines. Keep it clean around Howling Hill."},
{type:"links",pages:["side-activities","faction-quests","faction-rep","camp"]}
]},
...
"greymane-camp":{category:"Base Building",title:"Dispatch, Resources & Camp Management",
tags:["dispatch","freesword","resources","farm","ranch","recruit","supply","food","timber","stone","armaments","silver","missions","siege","resource loop","livestock","crops","trade","wages"],
content:[
{type:"intro",text:"Your camp isn't just a rest stop — it's an active management loop that directly powers your combat strength, economy, and open-world control. This guide covers the Freesword Dispatch system, the five-resource economy, farming and ranching, and advanced strategies for keeping your mercenary company thriving from mid-game through endgame."},
{type:"heading",text:"The Dispatch (Freesword) System"},
{type:"tip",text:"Send recruited Greymanes on off-screen missions that run in the background while you explore, fight, or quest. Missions progress on in-game time — sleep at camp to advance the clock faster."},
{type:"tip",text:"Access dispatches two ways: 1) Open map → Factions tab → select any location → Inspect → Missions tab → assign comrades → Dispatch. 2) Talk to Ross (Dispatch Coordinator) at camp for a single-screen overview of all available missions."},
{type:"tip",text:"Missions auto-restart when complete. Cancel manually to reassign comrades to different tasks. Cancelled missions refund resource costs in full."},
{type:"tip",text:"Always send more than the minimum number of recruits. Exceeding the minimum headcount earns bonus rewards."},
{type:"warning",text:"Keep missions running AT ALL TIMES. This is the single most reliable resource stream in the game. Never leave dispatch slots empty."},
{type:"heading",text:"Dispatch Skill Matching"},
{type:"tip",text:"Each Freesword has unique skills that affect mission performance. Matching skills to mission type = better yields + faster completion."},
{type:"table",headers:["Skill Type","Skills","Effect"],
rows:[
["Required (need at least one)","Craftsman, Jeweler, Engineer, Cook, Explorer, Painter, Weaver","Unlocks specific mission types. Without the required skill, the mission is unavailable."],
["Efficiency Boosters","Escort, Farmer, Rancher, Fisherman, Smith, Logger, Miner","Increases yields for matching mission types. Stack multiple for bigger bonuses."]
]},
{type:"tip",text:"High-trust companions are more effective on dispatch and return with better rewards. Invest in Trust before relying on dispatch income."},
{type:"heading",text:"Mission Types & Rewards"},
{type:"table",headers:["Mission Type","Rewards","Costs","Best Skill Match"],
rows:[
["Escort","Silver","Food","Escort"],
["Harvesting / Farming","Food, trade goods","Silver","Farmer, Rancher"],
["Mining","Stone","Silver, food","Miner"],
["Logging","Timber","Silver, food","Logger"],
["Recapture Stronghold","Fewer enemies in area","Armaments, food, silver","Escort"],
["Production","Crafted items","Armaments, food, silver","Engineer (required)"],
["Crafting","Items, trade goods","Varies","Craftsman (required)"]
]},
{type:"tip",text:"Siege dispatch: send mercenaries to besiege enemy forts → reduced enemy resistance when you visit. Camp management directly affects open-world difficulty."},
{type:"tip",text:"Blockade deployment: assign Freeswords to blockaded regions to thin enemy counts before you arrive. Great for clearing hard liberation zones."},
{type:"heading",text:"The Five Resources"},
{type:"stat",text:"Food — cooking ingredients, raw produce, meals. Drains fastest (wages + mission costs). Never let it hit zero.\nTimber — wood from logging. Used for expansions and construction.\nStone — ore from mining. Used for facility upgrades and fortifications.\nArmaments — weapons, armor, accessories. The late-game bottleneck.\nSilver — currency. Auto-deducted daily for mercenary wages."},
{type:"tip",text:"Donate unwanted gear to Carl → converts to camp resources. Check Supply Chest regularly (230-slot max) — rewards from dispatches accumulate silently."},
{type:"tip",text:"Camp Provisions: manually donate resources to build up the collective pool. This fuels dispatch missions, so keeping it stocked is critical."},
{type:"heading",text:"Resource Loop Strategies"},
{type:"tip",text:"Early game: run one Escort mission (Oakenshield Manor in Hernand) for silver + one Harvest mission (Capra Pasture) for food. Add Warspike Spearmaker for armament production."},
{type:"tip",text:"Smart chaining: Capra Pasture (1k bronze → 1k food) THEN Oakenshield Manor (120 food → 1.9k bronze). Profit on both legs."},
{type:"tip",text:"Mid-game money: Thornbriar Food Storage, Sungrove Manor, Azerian Manor in Demeniss region."},
{type:"tip",text:"Late game: Gorthak Ironworks (Ch10+, Delesyia) = thousands of armaments per run. This is how you fund the 4th Expansion."},
{type:"warning",text:"Food drains fastest because almost every mission type draws from the food pool AND mercenary wages consume it daily. Run harvest/ranch missions constantly."},
{type:"heading",text:"Farm"},
{type:"tip",text:"Unlock: speak to Kamu → complete apple picking mission at Glenbright Farm → dispatch a 'Build Farm' mission at Howling Hill. Kamu teaches basics once built."},
{type:"tip",text:"Dedicated crop plots for fruit, vegetables, and grains. Crops must be watered by hand — not set-and-forget. Harvest by physically picking crops from the plot."},
{type:"tip",text:"Farm expansion unlocks greater crop variety and increased yield per harvest cycle. Feeds directly into cooking and alchemy systems."},
{type:"tip",text:"Sleep at camp to speed up crop growth timers. Combined with dispatch timers, rest is the best time-management tool you have."},
{type:"heading",text:"Ranch"},
{type:"tip",text:"Unlock quest chain: 'A Rumor in Goldleaf Trading Post' → meet Ben → Milk Harvest Mission at Bloomwood Ranch (dispatch) → dispatch 'Build Ranch' at Howling Hill → Ben's Request (teaches ranch management: catching wild goats, registering livestock, slaughtering for meat)."},
{type:"table",headers:["Animal","Products","Notes"],
rows:[
["Chickens","Eggs","Easiest to maintain. Good early-game food source."],
["Cows","Milk, beef","High-value ingredients for advanced cooking recipes."],
["Goats","Milk, hides","Hides also useful for crafting leather gear."],
["Pigs","Pork, leather","Leather feeds into armor crafting pipeline."]
]},
{type:"tip",text:"Animals need regular care and physical interaction — feeding, moving between pens (Kliff can hoist goats/pigs onto his shoulders), and slaughtering through direct actions rather than menu prompts."},
{type:"tip",text:"Ranch expansion adds more animal types and increases production. Combined farm + ranch = self-sufficient food supply. Essential for endgame cooking and keeping morale high."},
{type:"heading",text:"Wages, Food & Morale Management"},
{type:"tip",text:"Silver is auto-deducted daily for mercenary wages. Cooked food and drinks (like Pywelian Ale) must be physically deposited into the Camp Ledger."},
{type:"tip",text:"Upgrade tents — forcing troops to sleep in rain tanks morale. Failed missions and battlefield losses also hurt morale."},
{type:"tip",text:"High morale: livelier camp interactions, better dispatch outcomes, positive dialogue. Low morale: subdued conversations, reduced mission efficiency, potential desertions."},
{type:"warning",text:"Below 20% morale = companions abandon camp overnight. Keep food stocked, pay wages, and avoid leading troops into massacres."},
{type:"heading",text:"Recruiting Greymanes"},
{type:"tip",text:"Story encounters: some rejoin automatically via main quests. Side quests: complete specific objectives before they agree. Passive arrivals: some hear rumors and show up on their own. Active recruitment: convince NPCs through dialogue choices."},
{type:"tip",text:"Only Greymane comrades are recruitable — random Freeswords in the world are NOT. Look for quests starting with 'A Rumor...' under the Grounds of the Sunrise faction tab."},
{type:"tip",text:"Up to 3 companions travel with Kliff at any time. Rotate regularly — each companion reacts differently to regions and situations. Non-active companions stay at camp for dispatch."},
{type:"tip",text:"More recruits = more dispatch slots = more resources = faster expansions. Recruiting is the single highest-priority activity throughout the game."},
{type:"heading",text:"Post-Ch7: Pailune Reconstruction"},
{type:"tip",text:"After Ch7: Homecoming, unlock Pailune — the Greymanes' homeland. Major reconstruction projects via Pailune Council + Pailune Institute."},
{type:"tip",text:"Large-scale projects that give dispatched recruits meaningful long-term work. Major late-game resource sink but unlocks endgame content and facilities."},
{type:"heading",text:"Advanced Tips"},
{type:"tip",text:"Camp growth boosts Hernandian Contribution reputation. This opens better trade deals and faction rewards."},
{type:"tip",text:"Sleep at camp to advance in-game time — speeds dispatch timers, crop growth, and mission completion. Sleep has a cooldown (~12 hours in-game) so you can't chain rest."},
{type:"tip",text:"Supply Chest collects items you couldn't pick up during missions. Check it after every outing — rewards pile up silently."},
{type:"warning",text:"No dedicated player storage at launch (post-launch update planned). Inventory is your only general storage. Complete Greymane Commissions for +81 inventory slots total."},
{type:"tip",text:"Customize camp appearance: rearrange furniture, place decorations, and arrange interiors by hand. Cosmetic but makes the camp feel like home."},
{type:"tip",text:"Prioritize gathering tools: buy Pickaxe + Logging Axe from Provisioner's Shop in Hernand early. Force Palm Attack substitutes for Pickaxe, Turning Slash substitutes for Logging Axe — but having tools is faster."},
{type:"links",pages:["camp","cooking-recipes","trading-wagons","faction-rep","research-institutes","mining-gathering"]}
]}
};
